...
//   Function retrieving and displaying farmer profiles, including details such as farm information, production data, and tenurial status for each farmer. 
...
if ($request->ajax()) {
  ...
  return response()->json([
                ...
                if (Auth::check()) {
                    ...
                    if ($admin) {
                        ...
                        return view('map.arcmap', compact('profile', 'farmProfile', 'farmLocation', 'totalRiceProduction',
                            'agriDistrictIds', 'polygonsIds', 'admin', 'searchQuery', 'searchType'));
                    } else {
                        return redirect()->route('login')->with('error', 'User not found.');
                    }
                } else {
     ...
     // Function to display the farmer profiling data, including personal information, farm details, and other relevant data for the farmer's profile.
 ...
 // Function to display the Agri Map, showing the locations of farmers based on the user's data, including farm locations and relevant geographical information.
     ...
     // Function responsible for saving farm data for a farmer, including details such as farm profile, production data, and other relevant information to the database.
    ...
    // Function to view farm data, displaying detailed information about the selected farm profile, including farm attributes, production data, and other related details.
    ...
    // Function to edit and update farm profile data, allowing modifications to farm details, production information, and other relevant attributes.
...
// Function to display the crop form and allow users to add crop data, triggered by a click event on the corresponding page in the Blade template.
...
// Function to handle CRUD operations for crop farm data: 
// - Create: Save new crop farm data to the database. 
// - Read: Display the crop farm details. 
// - Update: Modify existing crop farm data. 
// - Delete: Remove crop farm data from the database.
...
// retrieve all crop data from the database
