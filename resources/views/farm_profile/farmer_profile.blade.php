                               ...
                               <div class="row mr-4 mb-4">
                                <div class="col-md-12 d-flex justify-content-between align-items-center mb-3">
                                    <div class="text-start ml-3">
                                        <a href="{{ route('admin.farmersdata.farm', $farmProfile->personal_informations_id) }}" class="btn btn-primary" onclick="goBack()">Back</a>
                                    </div>
                                    <div class="text-end">
...
$(document).ready(function() {
    ...
    $.ajax({
        url: `/admin-view-farmer-profile/${farmProfile}`, // Use the farmData ID in the URL
        method: 'GET',
...
$(document).ready(function() {
    ...
    $.ajax({
        url: `/admin-view-farmer-profile/${farmProfile}`, // Update with your actual route
        method: 'GET',
        dataType: 'json',
...
$(document).ready(function() {
    ...
    $.ajax({
        url: `/admin-view-farmer-profile/${farmProfile}`, // Update with your actual route URL using farmProfile ID
        method: 'GET',
        success: function(response) {
            // Check if data is returned successfully
