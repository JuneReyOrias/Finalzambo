                    ...
                    <div class="user-details">
                        ...
                        <div class="input-box col-md-4">
                            ...
                            <div class="input-box col-md-4">
                                ...
                                <input type="text" class="form-control light-gray-placeholder farm_address" value="{{$farmprofiles->farm_address}}" name="farm_address" placeholder="Enter farm address" id="rice_farm_address_0" onkeypress="return blockSymbolsAndNumbers(event)">
                            </div>
                            <div class="input-box col-md-4">
                                <span class="details">No.of Years as Farmer:</span>
                                <input type="text" class="form-control light-gray-placeholder no_of_years_as_farmers" value="{{$farmprofiles->no_of_years_as_farmers}}" name="no_of_years_as_farmers" id="no_of_years_as_farmers_0" placeholder="Enter no fo years as farmers">
                            </div>
                            <div class="input-box col-md-4">
                                <span class="details">GPS Longitude:</span>
                                <input type="text" class="form-control light-gray-placeholder gps_longitude" value="{{$farmprofiles->gps_longitude}}" name="gps_longitude" id="gps_longitude_0" placeholder="GPS_longitude" readonly >
                              </div>
                              <div class="input-box col-md-4">
                                <span class="details">GPS Latitude:</span>
                                <input type="text" class="form-control light-gray-placeholder gps_latitude" value="{{$farmprofiles->gps_latitude}}" name="gps_latitude" id="gps_latitude_0"placeholder="GPS_latitude" readonly>
                              </div>
                ...
                <button type="button" class="btn btn-primary" id="saveLocation">
                    <i class="fas fa-save me-1"></i>Save
                            ...
                            <div class="input-box col-md-4">
                                ...
                                <input type="number" class="form-control light-gray-placeholder total_physical_area_has" value="{{$farmprofiles->total_physical_area}}" name="total_physical_area" id="total_physical_area_has_0"placeholder=" Enter Total Physical Area (has)" value="{{old('total_physical_area_has')}}" >
                            </div>
                            <div class="input-box col-md-4">
                                <span class="details">Total Area Cultivated (has):</span>
                                <input type="number" class="form-control light-gray-placeholder Total_area_cultivated_has" value="{{$farmprofiles->total_area_cultivated}}" name="total_area_cultivated"id="rice_area_cultivated_has_0" placeholder=" Enter total area cultivated has" value="{{'total_area_cultivated'}}">
                            </div>
                            <div class="input-box col-md-4">
                                <span class="details">Land Title No:</span>
                                <input type="text" class="form-control light-gray-placeholder land_title_no" value="{{$farmprofiles->land_title_no}}" name="land_title_no" id="land_title_no_0" placeholder="Enter land title no" value="{{old('land_title_no')}}">
                            </div>
                            <div class="input-box col-md-4">
                                <span class="details">Lot No:</span>
                                <input type="text" class="form-control light-gray-placeholder lot_no" name="lot_no" value="{{$farmprofiles->lot_no}}" id="lot_no_0" placeholder="Enter lot no" value="{{old('lot_no')}}">
                            </div>
                            <div class="input-box col-md-4">
                    ...
                    <div class="input-box col-md-4">
                        <span class="details">RSBA Register:</span>
                                ...
                                <select class="form-control custom-select light-gray-placeholder rsba_register placeholder-text @error('rsba_register') is-invalid @enderror" id="rsba_registered" name="rsba_register" aria-label="Floating label select e">
                                 
                                    <option value="1" {{ $farmprofiles->rsba_registered == 1 ? 'selected' : '' }}>Yes</option>
                                   <option value="0" {{ $farmprofiles->rsba_registered == 0 ? 'selected' : '' }}>No</option>
                            ...
                            <div class="input-box col-md-4">
                                ...
                                <select class="form-control custom-select light-gray-placeholder pcic_insured placeholder-text @error('pcic_insured') is-invalid @enderror" id="pcic_insured" name="pcic_insured" aria-label="Floating label select e">
                                    ...
                                    <option value="1" {{ $farmprofiles->pcic_insured == 1 ? 'selected' : '' }}>Yes</option>
                                    <option value="0" {{ $farmprofiles->pcic_insured == 0 ? 'selected' : '' }}>No</option>
                            ...
                            <div class="input-box col-md-4">
                                ...
                                <select class="form-control custom-select light-gray-placeholder government_assisted placeholder-text @error('government_assisted') is-invalid @enderror" id="government_assisted" name="government_assisted" aria-label="Floating label select e">
                                    ...
                                    <option value="1" {{ $farmprofiles->government_assisted == 1 ? 'selected' : '' }}>Yes</option>
                                    <option value="0" {{ $farmprofiles->government_assisted == 0 ? 'selected' : '' }}>No</option>
                            ...
                            <div class="input-box col-md-4">
                                <span class="details">Name of Field Officer:</span>
                            ...
                            <div class="input-box col-md-4">
                                ...
                                <input type="text" class="form-control light-gray-placeholder date_interview" value="{{$farmprofiles->date_interviewed}}" name="date_interviewed" id="datepicker" placeholder="date interview" required>
                            </div>
...
form.on('submit', function(event) {
    ...
    let farmerInfo = {
        ...
        'date_of_interview': $('input.date_of_interview').val(),
    };

    // Gather farm info from the form inputs
    let farmInfo = {
    'users_id': $('input.users_id').val(),
    'personalinfo_id': $('input.personalinfo_id').val(),
    'agri_districts': $('input.agri_districts').val(),
...
function initMap() {
    var initialLocation = { lat: 6.9214, lng: 122.0790 }; // Default location
    var existingLatitude = parseFloat("{{$farmprofiles->gps_latitude}}");
    var existingLongitude = parseFloat("{{$farmprofiles->gps_longitude}}");

    // Use existing GPS values if they are valid
    if (!isNaN(existingLatitude) && !isNaN(existingLongitude)) {
        initialLocation = { lat: existingLatitude, lng: existingLongitude };
    }
    ...
    // Add marker if existing GPS coordinates are available
    if (!isNaN(existingLatitude) && !isNaN(existingLongitude)) {
        var existingLocation = new google.maps.LatLng(existingLatitude, existingLongitude);
        addMarker(existingLocation);
        $('#modal_latitude').val(existingLatitude);
        $('#modal_longitude').val(existingLongitude);
    }
...
$(document).ready(function () {
    ...
    $('#mapModal').on('shown.bs.modal', function () {
        ...
        } else if (!isNaN(parseFloat("{{$farmprofiles->gps_latitude}}")) && !isNaN(parseFloat("{{$farmprofiles->gps_longitude}}"))) {
            var lat = parseFloat("{{$farmprofiles->gps_latitude}}");
            var lng = parseFloat("{{$farmprofiles->gps_longitude}}");
