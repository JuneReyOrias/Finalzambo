                                    ...
                                    <div class="auth-form-wrapper px-4 py-5">
                                        ...
                                        <form class="forms-sample " method="post" action="{{ route('register') }}">
                                            ...
                                            <div class="row mb-3">
                                                <div class="col-md-6">
                                                    <label for="exampleInputUsername1"
                                                        class="Login-register">FirstName</label>
                                                    <input type="text"
                                                        class="form-control @error('first_name') is-invalid @enderror"
                                                        id="exampleInputUsername1" name="first_name"
                                                        autocomplete="first_name" placeholder="FirstName"
                                                ...
                                                <div class="col-md-6">
                                                    <label for="exampleInputUsername1"
                                                        class="Login-register">LastName</label>
                                                    <input type="text"
                                                        class="form-control @error('last_name') is-invalid @enderror"
                                                        id="exampleInputUsername1" name="last_name"
                                                        autocomplete="last_name" placeholder="LastName"
                                                        value="{{ old('last_name') }}">
                                                    @error('last_name')
                                                        <div class="invalid-feedback">{{ $message }}</div>
                                                    @enderror
                                            ...
                                            <div class="row mb-3">
                                                <div class="col-md-6">
                                                    ...
                                                    <input type="email" name="email"
                                                        ...
                                                        id="userEmail" placeholder="Email" value="{{ old('email') }}">
                                                    @error('email')
                                                        <div class="invalid-feedback">{{ $message }}</div>
                                                    @enderror
                                                </div>
                                                <div class="col-md-6">
                                                    <label for="agri_district" class="Login-register">Agri
                                                        District</label>
                                                    <select
                                                        ...
                                                        <option value="ayala"
                                                            {{ old('district') == 'ayala' ? 'selected' : '' }}>Ayala
                                                            Distict</option>
                                                        <option value="tumaga"
                                                            {{ old('district') == 'tumaga' ? 'selected' : '' }}>Tumaga
                                                            District</option>
                                                        <option value="culianan"
                                                            {{ old('district') == 'culianan' ? 'selected' : '' }}>
                                                            Culianan District</option>
                                                        <option value="Manicahan District"
                                                            {{ old('district') == 'manicahan' ? 'selected' : '' }}>
                                                            Manicahan District</option>
                                                        <option value="curuan"
                                                            {{ old('district') == 'curuan' ? 'selected' : '' }}>Curuan
                                                            District</option>
                                                        <option value="vitali"
                                                            {{ old('district') == 'vitali' ? 'selected' : '' }}>Vitali
                                                            District</option>
                                                    </select>
                                                    @error('district')
                                                        <div class="invalid-feedback">{{ $message }}</div>
                                            ...
                                            <div class="row mb-3">
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="form-check mb-3">
                                                        ...
                                                        <label class="form-check-label"
                                                            for="togglePasswordVisibilityCheckbox">Show
                                                            Password</label>
                                                    </div>
                                                    @error('password')
                                                        <div class="invalid-feedback">{{ $message }}</div>
                                                ...
                                                <div class="col-md-6">
                                                    <label for="confirm_password" class="Login-register">confirm
                                                        Password</label>
                                                    <input type="password" name="confirm_password"
                                                        class="form-control @error('confirm_password') is-invalid @enderror"
                                                        id="confirm_password" autocomplete="current-confirm_password"
                                                        placeholder="Password" value="{{ old('confirm_password') }}">
                                                    {{-- <div class="form-check mb-3">
