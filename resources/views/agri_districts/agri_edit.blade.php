                    ...
                    <input type="hidden" class="form-control light-gray-placeholder" value="{{$userId}}"name="users_id" placeholder="Enter longitude" id="modal_longitude">
                        ...
                        <div class="input-box">
                            ...
                            <div class="input-box ">
                              ...
                              <textarea class="form-control light-gray-placeholder" 
                                        name="description" 
                                        id="description" 
                                        placeholder="Enter description" 
                                        rows="3" 
                                        onkeypress="return blockSymbolsAndNumbers(event)">
                                  {{ $AgriDistrict->description }}
                              </textarea>
                          </div>
                            ...
                            <div class="input-box ">
                                ...
                                <input type="text" class="form-control light-gray-placeholder longitude"value="{{$AgriDistrict->longitude}}"  name="longitude" id="gps_longitude_0" placeholder="GPS_longitude" readonly >
                              </div>
                              <div class="input-box ">
                                <span class="details">GPS Latitude:</span>
                                <input type="text" class="form-control light-gray-placeholder latitude" name="latitude"value="{{$AgriDistrict->latitude}}" id="gps_latitude_0"placeholder="GPS_latitude" readonly>
                              </div>
          ...
          <div class="modal-body">
              ...
              <div class="form-row mt-3">
                  <div class="col">
                      ...
                      <input type="text" class="form-control" value="{{ $AgriDistrict->latitude }}" placeholder="Enter latitude" id="modal_latitude">
                  </div>
                  <div class="col">
                      <label for="modal_longitude" class="form-label">Longitude:</label>
                      <input type="text" class="form-control" value="{{ $AgriDistrict->longitude }}" placeholder="Enter longitude" id="modal_longitude">
                  </div>
              </div>
          </div>
...
var map;
    ...
    $(document).ready(function() {
        // Track initial values of the latitude and longitude
        initialLat = $('#gps_latitude_0').val();
        initialLng = $('#gps_longitude_0').val();
        ...
        $('#saveLocation').on('click', function() {
            var lat = $('#modal_latitude').val().trim();
            var lng = $('#modal_longitude').val().trim();
