                    ...
                    <input type="radio" name="tabs" id="Fixed" checked="checked">
                        ...
                        <div class="tab">
                            <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                                ...
                                <a href="{{ route('admin.farmersdata.CrudFixed.add',$cropData->id) }}" title="Add Crop Production">
                                    <button class="btn btn-success btn-sm">
                                        <i class="fa fa-plus" aria-hidden="true"></i>
                                    </button>
                                </a>
                       ...
                       @csrf
                        ...
                        <div class="tab">
                            <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                                ...
                                <a href="{{ route('admin.farmersdata.CrudMachineries.add',$cropData->id) }}" title="Add Crop Production">
                                    <button class="btn btn-success btn-sm">
                                        <i class="fa fa-plus" aria-hidden="true"></i>
                                    </button>
                                </a>
                       ...
                       <td>
                        ...
                        <div class="tab">
                            <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                                ...
                                @if(isset($cropData) && $variableData->isEmpty())
                                <a href="{{ route('admin.farmersdata.CrudVariable.add',$cropData->id) }}" title="Add Variable Cost">
                                    <button class="btn btn-success btn-sm">
                                        <i class="fa fa-plus" aria-hidden="true"></i>
                                    </button>
                                </a>
...
{{--                             
                        ...
                        <div class="tab">
                            <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                                ...
                                <a href="{{route('admin.farmersdata.CrudSolds.add',$cropData->id)}}" title="Add farm">
                                    <button class="btn btn-success btn-sm">
                                        <i class="fa fa-plus" aria-hidden="true"></i>
                                    </button>
                                </a>
...
function productionCostData(id) {
    $.ajax({
        url: '/admin-edit-Farmers-productions/' + id, // Adjust the URL to match your route
        type: 'GET',
        dataType: 'json',
        ...
        error: function(xhr) {
            console.error('Error fetching data:', xhr); // Log the entire response for debugging
...
function fetchFixedCostData(id) {
    $.ajax({
        url: '/admin-edit-Farmers-fixedCost/' + id, // Adjust the URL to match your route
        type: 'GET',
        dataType: 'json',
...
function MachineCostData(id) {
    $.ajax({
        url: '/admin-edit-Farmers-Machineries-Cost/' + id, // Adjust the URL to match your route
        type: 'GET',
        dataType: 'json',
...
function VariableCostData(id) {
    $.ajax({
        url: '/admin-edit-Farmers-Variable-Cost/' + id, // Adjust the URL to match your route
        type: 'GET',
        dataType: 'json',
...
function SoldsCostData(id) {
    $.ajax({
        url: '/admin-edit-Farmers-Solds-Cost/' + id, // Adjust the URL to match your route
        type: 'GET',
        dataType: 'json',
