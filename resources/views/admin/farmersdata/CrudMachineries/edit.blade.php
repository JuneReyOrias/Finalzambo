...
@media (max-width: 376px) {
    ...
    .card-header {
            ...
            <div id="collapseFarmProfile" class="collapse show" aria-labelledby="headingFarmProfile" data-parent="#accordionFarmProfile">
                <div class="card-body">
                            ...
                            <div class="user-details">
                                ...
                                <div class="input-box col-md-4">
                                  ...
                                  <select class="form-control custom-select light-gray-placeholder crops_farms_id" name="crops_farms_id" id="crop_name">
                                    <option value="{{$machineriesData->crops_farms_id}}">{{$machineriesData->cropFarm->crop_name}}</option>
                              ...
                              <div class="input-box col-md-4">
                                ...
                                <select class="form-control custom-select light-gray-placeholder plowing-machine @error('plowing_machineries_used') is-invalid @enderror" 
                                            name="plowing_machineries_used" 
                                            id="selectPlowing" 
                                            onchange="checkPlowing()" 
                                            aria-label="label select e">
                                        <option value="{{$machineriesData->plowing_machineries_used}}">{{$machineriesData->plowing_machineries_used}}</option>
                        ...
                        <div class="input-box col-md-4">
                            ...
                            <input type="number" class="form-control light-gray-placeholder no_of_plowing @error('no_of_plowing') is-invalid @enderror" value="{{$machineriesData->no_of_plowing}}" name="no_of_plowing" id="noPlowing" placeholder="Enter no. of plowing" value="{{ old('no_of_plowing') }}">
                            @error('no_of_plowing')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
        ...
        <div class="input-box col-md-4">
            ...
            <div class="d-flex align-items-center">
                <select class="form-control custom-select light-gray-placeholder harro_machine @error('harrowing_machineries_used') is-invalid @enderror" 
                        ...
                        aria-label="label select e">
                    <option value="{{$machineriesData->harrowing_machineries_used}}">{{$machineriesData->harrowing_machineries_used}}</option>
            ...
            <div class="input-box col-md-4">
                ...
                <input type="number" class="form-control light-gray-placeholder no_of_harrowing @error('no_of_harrowing') is-invalid @enderror" value="{{$machineriesData->no_of_harrowing}}" name="no_of_harrowing" id="noHarrowing" placeholder="Enter no. of harrowing" value="{{ old('no_of_harrowing') }}">
            ...
            <div class="input-box col-md-4">
                ...
                <input type="number" class="form-control light-gray-placeholder cost_per_harrowing @error('harrowing_cost') is-invalid @enderror"value="{{$machineriesData->harrowing_cost}}" name="harrowing_cost" id="costPerHarrowingInput" placeholder="Enter cost per harrowing" value="{{ old('harrowing_cost') }}">
            ...
            <div class="input-box col-md-4">
                ...
                <input type="number" class="form-control light-gray-placeholder harrowing_cost_total @error('harrowing_cost_total') is-invalid @enderror"value="{{$machineriesData->harrowing_cost_total}}" name="harrowing_cost_total" id="totalHarrowingCostInput" placeholder="Total harrowing cost" value="{{ old('harrowing_cost_total') }}" readonly>
           ...
           <div class="input-box col-md-4">
                ...
                <div class="d-flex align-items-center">
                    <select class="form-control custom-select light-gray-placeholder harvest_machine @error('Harvesting_machineries_used') is-invalid @enderror" 
                            ...
                            aria-label="label select e">
                        <option value="{{$machineriesData->harvesting_machineries_used}}">{{$machineriesData->harvesting_machineries_used}}</option>
            ...
            <div class="input-box col-md-4">
                ...
                <div class="d-flex align-items-center">
                    <select class="form-control custom-select light-gray-placeholder harvest_ownership_status @error('harro_ownership_status') is-invalid @enderror" 
                            name="harvest_ownership_status" 
                            id="selectHarvestOwnership" 
                            onchange="checkHarvestOwnership()" 
                            aria-label="label select e">
                        <option value="{{$machineriesData->harvest_ownership_status}}">{{$machineriesData->harvest_ownership_status}}</option>
                        ...
                        <option value="Other" {{ old('harvest_ownership_status') == 'Other' ? 'selected' : '' }}>Other</option>
                    </select>
            ...
            <div class="input-box col-md-4">
                ...
                <input type="number" class="form-control light-gray-placeholder no_of_Harvesting @error('no_of_harvesting') is-invalid @enderror" value="{{$machineriesData->no_of_harvesting}}" name="no_of_harvesting" id="noHarvesting" placeholder="Enter no. of Harvesting" value="{{ old('no_of_Harvesting') }}">
            ...
            <div class="input-box col-md-4">
                ...
                <input type="number" class="form-control light-gray-placeholder cost_per_Harvesting @error('Harvesting_cost') is-invalid @enderror"value="{{$machineriesData->cost_per_harvesting}}" name="cost_per_harvesting" id="costPerHarvestingInput" placeholder="Enter cost per Harvesting" value="{{ old('Harvesting_cost') }}">
            ...
            <div class="input-box col-md-4">
                ...
                <input type="number" class="form-control light-gray-placeholder Harvesting_cost_total @error('Harvesting_cost_total') is-invalid @enderror"value="{{$machineriesData->harvesting_cost_total}}" name="harvesting_cost_total" id="totalHarvestingCostInput" placeholder="Total Harvesting cost" value="{{ old('Harvesting_cost_total') }}" readonly>
      ...
      <h3>d. Post Harvest Machineries  </h3>
          ...
          <div class="input-box col-md-4">
                ...
                <div class="d-flex align-items-center">
                    <select class="form-control custom-select light-gray-placeholder postharves_machine @error('postharvest_machineries_used') is-invalid @enderror"  
                            ...
                            aria-label="label select e">
                        <option value="{{$machineriesData->postharvest_machineries_used}}">{{$machineriesData->postharvest_machineries_used}}</option>
           ...
           <div class="input-box col-md-4">
                <span class="details">Post Harvest Machineries Used</span>
                <div class="d-flex align-items-center">
                    <select class="form-control custom-select light-gray-placeholder postharv_ownership_status @error('postharv_ownership_status') is-invalid @enderror" 
                            name="postharv_ownership_status" 
                            id="selectPostHarvestMachineries" 
                            onchange="checkPostHarvestMachineries()" 
                            aria-label="label select e">
                            <option value="{{$machineriesData->postharv_ownership_status}}">{{$machineriesData->postharv_ownership_status}}</option>
                        ...
                        <option value="Other" {{ old('postharv_ownership_status') == 'Other' ? 'selected' : '' }}>Other</option>
                    </select>
                ...
                <div class="input-box col-md-4">
                    ...
                    <input type="number" class="form-control light-gray-placeholder postharvestCost @error('last_name') is-invalid @enderror" value="{{$machineriesData->post_harvest_cost}}" name="post_harvest_cost" id="postHarvestCostInput" placeholder="Enter no. of postharvest cost" value="{{ old('no_of_harrowing') }}" >
                    @error('last_name')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
                </div>
        ...
        <input type="number" class="form-control light-gray-placeholder total_cost_for_machineries @error('total_cost_for_machineries') is-invalid @enderror" value="{{$machineriesData->total_cost_for_machineries}}" name="total_cost_for_machineries" id="totalCostInput"  placeholder="Enter total expenses" value="{{ old('total_cost_for_machineries') }}">
        @error('last_name')
        <div class="invalid-feedback">{{ $message }}</div>
        @enderror
        </div>
