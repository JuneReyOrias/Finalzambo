...
@media (max-width: 376px) {
    ...
    .card-header {
                                        ...
                                        <div class="card-forms border rounded">
                                            ...
                                            <div class="card-forms border rounded">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    @endif
                                                <div class="content">
                                    <form action{{'VariableUpdate'}} method="POST">
                                        @csrf
        ...
        <div class="step active farm-info" id="step2">
            ...
            <div id="collapseFarmProfile" class="collapse show" aria-labelledby="headingFarmProfile" data-parent="#accordionFarmProfile">
                          ...
                          <input type="hidden" class="form-control users_id" placeholder="no of cropping/year" name="users_id" value="{{$userId}}" id="no_of_cropping_per_year">
                            ...
                            <div class="user-details">
                                ...
                                <div class="input-box col-md-4">
                                  ...
                                  <select class="form-control custom-select light-gray-placeholder crops_farms_id" name="crops_farms_id" id="crop_name">
                                    <option value="{{$variablesData->crops_farms_id}}">{{$variablesData->cropFarm->crop_name}}</option>
                              ...
                              <div class="input-box col-md-4">
                                ...
                                <div class="d-flex align-items-center">
                                    <select class="form-control seed_name" id="seed_name" name="seed_name" onchange="checkSeedName()">
                                        <option value="{{$variablesData->seed_name}}" >{{$variablesData->seed_name}}</option>
                                ...
                                <div class="input-box col-md-4">
                                    ...
                                    <div class="d-flex align-items-center">
                                        <select class="form-control custom-select light-gray-placeholder unit placeholder-text @error('unit') is-invalid @enderror" id="unit" name="unit" onchange="Unit()">
                                            <option value="{{$variablesData->unit}}">{{$variablesData->unit}}</option>
                                ...
                                <div class="input-box col-md-4">
                                    ...
                                    <input type="number" class="form-control light-gray-placeholder quantity" value="{{$variablesData->quantity}}" name="quantity" id="quantityInput" placeholder="Enter quantity" value="{{ old('quantity') }}">
                                </div>
                                
                                <div class="input-box col-md-4">
                                    <span class="details">Unit Price (PHP)</span>
                                    <input type="number" class="form-control light-gray-placeholder unit_price_seed" value="{{number_format($variablesData->unit_price,2)}}" name="unit_price" id="unitPriceInput" placeholder="Enter unit price" value="{{ old('unit_price') }}">
                                </div>
                                
                                <div class="input-box col-md-4">
                                    <span class="details">Total Seed Cost (PHP)</span>
                                    <input type="number" class="form-control light-gray-placeholder total_seed_cost"value="{{number_format($variablesData->total_seed_cost,2)}}" name="total_seed_cost" id="totalSeedCostInput" placeholder="Enter total seed cost" value="{{ old('total_seed_cost') }}" readonly>
                                </div>
                              ...
                              <br>
                                ...
                                <div class="user-details">
                                    <div class="input-box col-md-4">
                                        ...
                                        <input type="number" class="form-control light-gray-placeholder no_of_person"value="{{$variablesData->labor_no_of_person}}" name="labor_no_of_person" id="noOfPersonInput" placeholder="Enter no. of persons" value="{{ old('no_of_person') }}">
                                    </div>
                                    
                                    <div class="input-box col-md-4">
                                        <span class="details">Rate per Person</span>
                                        <input type="number" class="form-control light-gray-placeholder rate_per_person"value="{{number_format($variablesData->rate_per_person,2)}}" name="rate_per_person" id="ratePerPersonInput" placeholder="Enter rate/person" value="{{ old('rate_per_person') }}">
                                    </div>
                                    
                                    <div class="input-box col-md-4">
                                        <span class="details">Total Labor Cost (PHP)</span>
                                        <input type="number" class="form-control light-gray-placeholder total_labor_cost" value="{{number_format($variablesData->total_labor_cost,2)}}" name="total_labor_cost" id="totalLaborCostInput" placeholder="Enter total labor cost" value="{{ old('total_labor_cost') }}" readonly>
                                    </div>
                          </div>
                 ...
                 <div class="input-box col-md-4">
                    ...
                    <div class="d-flex align-items-center">
                        <select class="form-control custom-select light-gray-placeholder name_of_fertilizer @error('name_of_fertilizer') is-invalid @enderror" 
                            ...
                            <option value="{{$variablesData->name_of_fertilizer}}">{{$variablesData->name_of_fertilizer}}</option>
                ...
                <div class="input-box col-md-4">
                    ...
                    <input type="number" id="noOfSacksInput" class="form-control light-gray-placeholder no_ofsacks" value="{{$variablesData->no_of_sacks}}" name="no_of_sacks" placeholder="Enter no of sacks" value="{{ old('no_ofsacks') }}">
                </div>
                
                <div class="input-box col-md-4">
                    <span class="details">Unit Price per Sack (PHP)</span>
                    <input type="number" class="form-control light-gray-placeholder unitprice_per_sacks" value="{{$variablesData->unit_price_per_sacks}}" name="unit_price_per_sacks" id="unitPricePerSacksInput" placeholder="Enter unit price/sack" value="{{ old('unitprice_per_sacks') }}">
                </div>
                
                <div class="input-box col-md-4">
                    <span class="details">Total Cost Fertilizers (PHP)</span>
                    <input type="number" class="form-control light-gray-placeholder total_cost_fertilizers" value="{{$variablesData->total_cost_fertilizers}}" name="total_cost_fertilizers" id="totalCostFertilizersInput" placeholder="Enter total cost" value="{{ old('total_cost_fertilizers') }}" readonly>
                </div>
          ...
          <br>
            ...
            <div class="user-details">
             ...
             <div class="input-box col-md-4">
                ...
                <div class="d-flex align-items-center">
                    <select class="form-control custom-select light-gray-placeholder pesticides_name @error('pesticide_name') is-invalid @enderror" 
                            name="pesticide_name" 
                            id="selectPesticideName" 
                            onchange="checkPesticideName()" 
                            aria-label="Floating label select e">
                        <option value="{{$variablesData->pesticide_name}}">{{$variablesData->pesticide_name}}</option>
                        <option value="Glyphosate" {{ old('pesticide_name') == 'Glyphosate' ? 'selected' : '' }}>Glyphosate</option>
                        <option value="Malathion" {{ old('pesticide_name') == 'Malathion' ? 'selected' : '' }}>Malathion</option>
                        <option value="Diazinon" {{ old('pesticide_name') == 'Diazinon' ? 'selected' : '' }}>Diazinon</option>
                        <option value="Chlorpyrifos" {{ old('pesticide_name') == 'Chlorpyrifos' ? 'selected' : '' }}>Chlorpyrifos</option>
                        <option value="Lambda-cyhalothrin" {{ old('pesticide_name') == 'Lambda-cyhalothrin' ? 'selected' : '' }}>Lambda-cyhalothrin</option>
                        <option value="Imidacloprid" {{ old('pesticide_name') == 'Imidacloprid' ? 'selected' : '' }}>Imidacloprid</option>
                        <option value="Cypermethrin" {{ old('pesticide_name') == 'Cypermethrin' ? 'selected' : '' }}>Cypermethrin</option>
                        <option value="N/A" {{ old('pesticide_name') == 'N/A' ? 'selected' : '' }}>N/A</option>
                        <option value="OtherPestName" {{ old('pesticide_name') == 'OtherPestName' ? 'selected' : '' }}>Others</option>
                    </select>
            ...
            <div class="input-box col-md-4">
                ...
                <input type="number" class="form-control light-gray-placeholder no_of_l_kg" value="{{$variablesData->no_of_l_kg}}" name="no_of_l_kg" id="noOfLKgInput" placeholder="Enter no of L or Kg" value="{{ old('no_of_l_kg') }}">
            </div>
            
            <div class="input-box col-md-4">
                <span class="details">Unit Price of Pesticides (PHP)</span>
                <input type="number" class="form-control light-gray-placeholder unitprice_ofpesticides" value="{{$variablesData->unit_price_of_pesticides}}" name="unit_price_of_pesticides" id="unitPricePesticidesInput" placeholder="Enter unit price of pesticides" value="{{ old('unitprice_ofpesticides') }}">
            </div>
            
            <div class="input-box col-md-4">
                <span class="details">Total Cost Pesticides (PHP)</span>
                <input type="number" class="form-control light-gray-placeholder total_cost_pesticides" value="{{$variablesData->total_cost_pesticides}}" name="total_cost_pesticides" id="totalCostPesticidesInput" placeholder="Enter total cost" value="{{ old('total_cost_pesticides') }}" readonly>
            </div>
      ...
      <div class="input-box col-md-4" >
        ...
        <input type="text"class="form-control light-gray-placeholder type_of_vehicle"value="{{$variablesData->name_of_vehicle}}" name="name_of_vehicle" id="unitPriceInput" placeholder="Enter type of vehicle" value="{{ old('type_of_vehicle') }}" onkeypress="return blockSymbolsAndNumbers(event)">
      
      </div>
  
      <div class="input-box col-md-4">
        <span class="details">Total Delivery Cost (PHP)</span>
        <input type="number" class="form-control light-gray-placeholder total_transport_per_deliverycost"value="{{$variablesData->total_transport_delivery_cost}}" name="total_transport_delivery_cost" id="totalDeliveryCostInput" placeholder="Enter total transport cost" value="{{ old('total_transport_per_deliverycost') }}">
    </div>
      <div class="input-box col-md-4">
        <span class="details">Total Machineries Fuel Cost (PHP)</span>
        <input type="number" class="form-control light-gray-placeholder total_machinery_fuel_cost"value="{{$variablesData->total_machinery_fuel_cost}}" name="total_machinery_fuel_cost" id="totalMachineryFuelCostInput" placeholder="Enter total fuel cost" value="{{ old('total_machinery_fuel_cost') }}">
    </div>
    
      <div class="input-box col-md-4">
        <span class="details">Total Variable Cost (PHP)</span>
        <input type="number" class="form-control light-gray-placeholder total_variable_costs"value="{{$variablesData->total_variable_cost}}" name="total_variable_cost" id="totalVariableCostInput" placeholder="Enter total variable cost" value="{{ old('total_variable_cost') }}" readonly>
    </div>
                        </div>
                        </div>
