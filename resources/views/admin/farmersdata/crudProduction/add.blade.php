            ...
            <div class="card crop-section mb-3" id="crop">
                ...
                <div id="collapseCrop" class="collapse" aria-labelledby="headingCrop">
                    <div class="card-body">
                        ...
                        <!-- Crop Fields -->
                          <input type="hidden" class="form-control farm_id" placeholder="no of cropping/year"value="{{$cropData->id}}" id="no_of_cropping_per_year">
                            
                         <div class="input-box col-md-4">
                              
                            <span class="details">Crop Name</span>
                                <select class="form-control crops_farms_id" id="crop_name">
                        ...
                        <div class="accordion" id="accordionCropDetails">
                            <!-- Add Production Section -->
                            <div class="card">
                                <div class="card-header" id="headingProduction" style="background-color: #e9ecef; border: none; padding: 10px 20px;">
                                    <h5 class="mb-0" style="margin: 0;">
                                        <button class="btn btn-modern collapsed" type="button" data-toggle="collapse" data-target="#collapseProduction" aria-expanded="false" aria-controls="collapseProduction">
                                            Add Production
                                        </button>
                                    </h5>
                                </div>
                                <div id="collapseProduction" class="collapse" aria-labelledby="headingProduction" data-parent="#accordionCropDetails">
                                    <div class="card-body">
                                        ...
                                        <div class="input-box col-md-4">
                                          ...
                                          <div class="input-box col-md-4">
                                            ...
                                            <input type="number" class="form-control light-gray-placeholder seed-used" name="crop_profiles[${cropCounter}][seeds_used_in_kg]"placeholder=" Enter Seed used in kg" id="seeds_used_in_kg">
                                  ...
                                  <div class="input-box col-md-4">
                                        ...
                                        @enderror
                                         ...
                                         <div class="input-box col-md-4">
                                            ...
                                            <input type="text" class="form-control light-gray-placeholder unit" name="crop_profiles[${cropCounter}][unit]"placeholder=" Enter unit" id="unit" onkeypress="return blockSymbolsAndNumbers(event)">
                                        </div>
                                          <div class="input-box col-md-4">
                                            <label for="no_of_fertilizer_used_in_bags">no of fertilizer used in bags:</label>
                                            <input type="number" class="form-control light-gray-placeholder fertilized-used" name="crop_profiles[${cropCounter}][no_of_fertilizer_used_in_bags]" placeholder=" Enter no of fertilizers used in bags" id="no_of_fertilizer_used_in_bags">
                                        </div>
                                         <div class="input-box col-md-4">
                                            <label for="no_of_pesticides_used_in_l_per_kg">no of pesticides used in L/KG:</label>
                                            <input type="number" class="form-control light-gray-placeholder pesticides-used" name="crop_profiles[${cropCounter}][no_of_pesticides_used_in_l_per_kg]" placeholder="no of cropping/year" id="no_of_pesticides_used_in_l_per_kg">
                                        </div>
                                        <div class="input-box col-md-4">
                                            <label for="no_of_insecticides_used_in_l">no of insecticides used in L/KG:</label>
                                            <input type="number" class="form-control light-gray-placeholder insecticides-used" name="crop_profiles[${cropCounter}][no_of_insecticides_used_in_l_]" placeholder="no of cropping/year" id="no_of_insecticides_used_in_l">
                                        </div>
                                    ...
                                    <h3>b. Crop Planting Details</h3>
                                        <div class="user-details">
                                            ...
                                            <input type="number" class="form-control light-gray-placeholder area-planted" name="crop_profiles[${cropCounter}][area_planted]" placeholder="Area Planted" >
                                        </div>

                                         <div class="input-box col-md-4">
                                            <label for="date_planted">Date Planted:</label>
                                            <input type="text" class="form-control light-gray-placeholder date-planted" name="crop_profiles[${cropCounter}][date_planted]" placeholder="Date Planted"  id="datepicker">
                                        </div>
                                    <div class="input-box col-md-4">
                                            <label for="date_planted">Date Harvested:</label>
                                            <input type="text" class="form-control light-gray-placeholder date-harvested" name="crop_profiles[${cropCounter}][date_planted]" placeholder="Date harvested"  id="datepicker">
                                        </div>
                                         <div class="input-box col-md-4">
                                            <label for="yield_tons_per_kg">Yield Kg/Tons:</label>
                                            <input type="number" class="form-control light-gray-placeholder yield-kg" name="crop_profiles[${cropCounter}][yield_tons_per_kg]" placeholder="Yield Kg/Tons" id="yield_tons_per_kg">
                                        </div>
...
;
        ...
        <!-- Buttons outside the accordions -->
            <div class="button-container mt-3 d-flex justify-content-between">
                <a href="{{ route('admin.farmersdata.production', $cropData->id) }}" button type="button" class="btn btn-primary">Back</button></a>
