        ...
        <div class="col-lg-4">
          <div class="card mb-4">
            <div class="card-body text-center">
              <!-- Display admin image or default profile -->
              @if ($admin->image)
                <img src="/adminimages/{{$admin->image}}" name="image" id="showImage" alt="profile" class="rounded-circle img-fluid" style="width: 150px; height: 140px;">
              @else
            ...
            <div class="card-body">
              <form action{{ url('Userupdate') }} method="post" enctype="multipart/form-data">
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-9">
                    <input type="text" class="form-control" name="name" autocomplete="off" value="{{$admin->first_name.' '.$admin->last_name}}"@readonly(true)>
                  </div>
                </div>
                <hr>
                <div class="row">
                  ...
                  <div class="col-sm-9">
                    <input type="email" class="form-control" name="email" id="exampleInputEmail1" value="{{$admin->email}}" readonly>
                  </div>
                </div>
                <hr>
                <div class="row">
                  ...
                  <div class="col-sm-9">
                    <input type="text" class="form-control"name="district" id="district" autocomplete="off" value="{{$admin->district}}"@readonly(true)>
                  </div>
                </div>
                <hr>
                <div class="row">
                  ...
                  <div class="col-sm-9">
                    <input type="text" class="form-control"name="role" id="role" autocomplete="off" value="{{$admin->role}}" readonly>
                  </div>
                </div>
                <hr>
  {{--   
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-9"> --}}
                    {{-- <img class="rounded-circle" name="image" id="showImage" src="/agentimages/{{$admin->image}}" alt="profile"> --}}
               {{-- Image preview section --}}
                  {{-- @if ($admin->image)
                  <img src="/agentimages/{{$admin->image}}" name="image" id="showImage" alt="profile" class="rounded-circle img-fluid" style="width: 150px; height: 140px;">
                  @else
                  <img src="/upload/profile.jpg" name="image" id="showImage" alt="default avatar" class="rounded-circle img-fluid" style="width: 150px; height: 140px;">
                  @endif --}}
