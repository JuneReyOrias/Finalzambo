  ...
  <div class="main-wrapper"  style=" background-image: url(upload/rice.jpg);">
			...
			<div class="page-content d-flex align-items-center justify-content-center">
                ...
                <div class="col-md-8 ps-md-0">
                  <div class="auth-form-wrapper px-4 py-5">
                    ...
                    <form class="forms-sample " method="post" action{{ url('farmer') }}>
                        @csrf
                         <!-- Row with two columns for FullName and Email address -->
                      <div class="row mb-3">
                        <div class="col-md-6">
                            <label for="exampleInputUsername1" class="Login-register">FirstName</label>
                            <input type="text" class="form-control @error('first_name') is-invalid @enderror" id="first_name" name="first_name" autocomplete="first_name" placeholder="FirstName" value="{{ old('first_name') }}">
                            @error('first_name')
                                              ...
                                              @enderror
                                                        ...
                                                        {{-- <div class="col-md-6">
                                                          ...
                                                          <select class="form-control  @error('agri_district') is-invalid @enderror"  name="role" id="validationCustom01" aria-label="Floating label select e">
                                                            ...
                                                            <option value="agent" {{ old('role') == 'agent' ? 'selected' : '' }}>admin</option>
                                                            <option value="user" {{ old('role') == 'user' ? 'selected' : '' }}>admin</option>
                                                                            </select>
                                                                                 @error('role')
                                                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                                                      @enderror
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            Swal.fire({
                icon: 'success', // Change to 'error', 'warning', 'info', or 'question' if needed
                title: 'Success',
  ...
  <script>
    ...
    function checkPasswordMatch() {
        ...
        if (password !== confirmPassword) {
            ...
            mismatchWarning.style.display = "none"; // Hide warning
        }
    }
</script>
</body>
