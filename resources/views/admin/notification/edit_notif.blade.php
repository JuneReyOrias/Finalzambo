            ...
            <div class="card-body">
                ...
                <div class="card-header">
                    <ul class="nav nav-tabs card-header-tabs" id="myTab" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active" id="users-tab" data-toggle="tab" href="#users" role="tab" aria-controls="users" aria-selected="true">Edit Notification</a>
                        </li>
                        {{-- <li class="nav-item">
                        ...
                        <form method="POST" action{{ url('Messagestore') }}>
                            ...
                            <div class="user-details d-flex">
                                ...
                                <div class="input-box flex-fill">
                                    ...
                                    <input type="text" class="form-control" placeholder="message"value="{{$notif->message}}" name="message" id="user_message">
                                </div>
                            </div>
