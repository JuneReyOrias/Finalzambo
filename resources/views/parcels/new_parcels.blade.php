                 ...
                 --}}
                        ...
                        {{-- --}} <input type="hidden" class="form-control light-gray-placeholder users_id" name="users_id" value="{{$userId}}">
                            <div class="input-box col-md-4">
                              ...
                              <input type="text" class="form-control light-gray-placeholder parcel_name"name="parcel_name" placeholder="Enter parcel name" id="rice_farm_address_0" onkeypress="return blockSymbolsAndNumbers(event)">
                          </div>
                            <div class="input-box col-md-4">
                                <span class="details">ARP OwnerName:</span>
                                <input type="text" class="form-control light-gray-placeholder arpowner_na"name="arpowner_na" placeholder="Enter ARP OwnerName" id="rice_farm_address_0" onkeypress="return blockSymbolsAndNumbers(event)">
                            </div>
                            ...
                            <div class="input-box col-md-4">
                              ...
                              <input type="text" class="form-control light-gray-placeholder tct_no"name="tct_no" placeholder="Enter Land Title no." id="rice_farm_address_0" >
                          </div>

                          <div class="input-box col-md-4">
                            <span class="details">Lot no:</span>
                            <input type="text" class="form-control light-gray-placeholder lot_no"name="lot_no" placeholder="Enter Lot no" id="rice_farm_address_0" >
                        </div>

                        <div class="input-box col-md-4">
                          <span class="details">PKind Description:</span>
                          <input type="text" class="form-control light-gray-placeholder pkind_desc"name="pkind_desc" placeholder="Enter PKind Description" id="rice_farm_address_0" onkeypress="return blockSymbolsAndNumbers(event)">
                      </div>

                      <div class="input-box col-md-4">
                        <span class="details">PUsed Description:</span>
                        <input type="text" class="form-control light-gray-placeholder puse_desc"name="puse_desc" placeholder="Enter PUsed Description" id="rice_farm_address_0" onkeypress="return blockSymbolsAndNumbers(event)">
                    </div>

                    <div class="input-box col-md-4">
                      <span class="details">Actual Used:</span>
                      <input type="text" class="form-control light-gray-placeholder actual_used"name="actual_used" placeholder="Enter Actual Used" id="rice_farm_address_0" onkeypress="return blockSymbolsAndNumbers(event)">
                  </div>
