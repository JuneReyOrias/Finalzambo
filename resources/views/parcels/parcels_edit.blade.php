        ...
        <div class="card">
            ...
            <div id="collapseFarmProfile" class="collapse show" aria-labelledby="headingFarmProfile" data-parent="#accordionFarmProfile">
                 ...
                 --}}
                        ...
                        <div class="user-details">
                            ...
                            <div class="input-box col-md-4">
                                ...
                                <input type="text" class="form-control light-gray-placeholder parcel_name"name="parcel_name" value="{{$parcels->parcel_name}}" placeholder="Enter parcel name" id="boarder-name" onkeypress="return blockSymbolsAndNumbers(event)">
                            </div>
                              <div class="input-box col-md-4">
                              ...
                              <div class="input-box col-md-4">
                                ...
                                <input type="text" class="form-control light-gray-placeholder tct_no" value="{{$parcels->tct_no}}"  name="tct_no" placeholder="Enter Land Title no." id="landTitle" >
                            </div>
  
                            <div class="input-box col-md-4">
                              <span class="details">Lot no:</span>
                              <input type="text" class="form-control light-gray-placeholder lot_no" value="{{$parcels->lot_no}}"  name="lot_no" placeholder="Enter Lot no" id="lotNo" >
                          </div>
  
                          <div class="input-box col-md-4">
                            <span class="details">PKind Description:</span>
                            <input type="text" class="form-control light-gray-placeholder pkind_desc"value="{{$parcels->pkind_desc}}"     name="pkind_desc" placeholder="Enter PKind Description" id="pkind_desc" onkeypress="return blockSymbolsAndNumbers(event)">
                        </div>
  
                        <div class="input-box col-md-4">
                          <span class="details">PUsed Description:</span>
                          <input type="text" class="form-control light-gray-placeholder puse_desc" value="{{$parcels->puse_desc}}"   name="puse_desc" placeholder="Enter PUsed Description" id="puse_desc" onkeypress="return blockSymbolsAndNumbers(event)">
                      </div>
  
                      <div class="input-box col-md-4">
                        <span class="details">Actual Used:</span>
                        <input type="text" class="form-control light-gray-placeholder actual_used" value="{{$parcels->actual_used}}"    name="actual_used" placeholder="Enter Actual Used" id="actual_used" onkeypress="return blockSymbolsAndNumbers(event)">
                    </div>
                ...
                <div class="input-box col-md-4">
                    ...
                    <div class="d-flex align-items-center">
                        <select class="form-control custom-select" name="strokecolor" id="stroke-color-select" aria-label="Stroke color select">
                            <option value="{{$parcels->strokecolor}}">{{$parcels->strokecolor}}  </option>
                ...
                <div class="input-box col-md-4">
                    ...
                    <input type="text" class="form-control light-gray-placeholder"value="{{$parcels->area}}"   name="area" id="area" placeholder="Area" readonly>
                </div>
                
                <div class="input-box col-md-4">
                    <span class="details">Altitude:</span>
                    <input type="text" class="form-control light-gray-placeholder"value="{{$parcels->altitude}}"    name="altitude" id="altitude" placeholder="Altitude" readonly>
                </div>
                
                <div class="input-box col-md-4">
                    <span class="details">Polygon Coordinates:</span>
                    <textarea id="polygon-coordinates" rows="5" cols="50" class="form-control light-gray-placeholder" name="coordinates" placeholder="Polygon Coordinates" readonly>{{$parcels->coordinates}}</textarea>
                </div>
...
// Function to remove the selected polygon
document.getElementById('remove-polygon').addEventListener('click', function () {
    if (selectedShape) {
        selectedShape.setMap(null); // Remove the polygon from the map
        selectedShape = null; // Reset the selected shape variable
        document.getElementById('area').value = ''; // Clear the area input
        document.getElementById('altitude').value = ''; // Clear the altitude input
        document.getElementById('polygon-coordinates').value = ''; // Clear the coordinates textarea
...
document.getElementById('save-polygon').addEventListener('click', function () {
    ...
    // Get area and other details from the form
    var polygonName = document.getElementById('boarder-name').value;
    var area = document.getElementById('area').value;
    var altitude = document.getElementById('altitude').value;
    var arpowner_na = document.getElementById('arpowner_na').value;
    ...
    xhr.onreadystatechange = function () {
        if (xhr.readyState === 4 && xhr.status === 200) {
            ...
            if (response.success) {
                alert("Polygon saved successfully!");
                // You can update the page content here instead of reloading the page
            } else {
                alert("Error saving polygon. Please try again.");
            }
        }
...
function loadPolygons() {
    ...
    mapdata.forEach(function (parcel) {
        ...
        google.maps.event.addListener(polygon, 'click', function () {
            ...
            var contentString = `
                Parcel ID: ${parcel.parcel_name}<br>
                Area: ${parcel.area} sq. meters<br>
                Altitude: ${parcel.altitude} meters<br>
