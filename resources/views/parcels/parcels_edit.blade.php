            ...
            <div id="collapseFarmProfile" class="collapse show" aria-labelledby="headingFarmProfile" data-parent="#accordionFarmProfile">
                <div class="card-body">
                 ...
                 --}}
                        ...
                        {{-- --}} <input type="hidden" class="form-control light-gray-placeholder users_id" name="users_id" value="{{$parcels->users_id}}">
                            <div class="input-box col-md-4">
                              <span class="details">Parcel Name:</span>
                              <input type="text" class="form-control light-gray-placeholder parcel_name"value="{{$parcels->parcel_name}}" name="parcel_name" placeholder="Enter parcel name" id="rice_farm_address_0" onkeypress="return blockSymbolsAndNumbers(event)">
                          </div>
                            <div class="input-box col-md-4">
                                <span class="details">ARP OwnerName:</span>
                                <input type="text" class="form-control light-gray-placeholder arpowner_na" value="{{$parcels->arpowner_na}}" name="arpowner_na" placeholder="Enter ARP OwnerName" id="rice_farm_address_0" onkeypress="return blockSymbolsAndNumbers(event)">
                            </div>
                            ...
                            <div class="input-box col-md-4">
                              ...
                              <input type="text" class="form-control light-gray-placeholder tct_no" value="{{$parcels->tct_no}}" name="tct_no" placeholder="Enter Land Title no." id="rice_farm_address_0" >
                          </div>

                          <div class="input-box col-md-4">
                            <span class="details">Lot no:</span>
                            <input type="text" class="form-control light-gray-placeholder lot_no" value="{{$parcels->lot_no}}" name="lot_no" placeholder="Enter Lot no" id="rice_farm_address_0" >
                        </div>

                        <div class="input-box col-md-4">
                          <span class="details">PKind Description:</span>
                          <input type="text" class="form-control light-gray-placeholder pkind_desc" value="{{$parcels->pkind_desc}}" name="pkind_desc" placeholder="Enter PKind Description" id="rice_farm_address_0" onkeypress="return blockSymbolsAndNumbers(event)">
                      </div>

                      <div class="input-box col-md-4">
                        <span class="details">PUsed Description:</span>
                        <input type="text" class="form-control light-gray-placeholder puse_desc" value="{{$parcels->puse_desc}}" name="puse_desc" placeholder="Enter PUsed Description" id="rice_farm_address_0" onkeypress="return blockSymbolsAndNumbers(event)">
                    </div>

                    <div class="input-box col-md-4">
                      <span class="details">Actual Used:</span>
                      <input type="text" class="form-control light-gray-placeholder actual_used" value="{{$parcels->actual_used}}" name="actual_used" placeholder="Enter Actual Used" id="rice_farm_address_0" onkeypress="return blockSymbolsAndNumbers(event)">
                  </div>

               
                  <div class="input-box col-md-4">
                  <span class="details">GPS Longitude:</span>
                  <input type="text" class="form-control light-gray-placeholder longitude" value="{{$parcels->longitude}}" name="longitude" id="gps_longitude_0" placeholder="GPS_longitude" readonly>
                </div>
                <div class="input-box col-md-4">
                    <span class="details">GPS Latitude:</span>
                    <input type="text" class="form-control light-gray-placeholder latitude" value="{{$parcels->latitude}}" name="latitude" id="gps_latitude_0" placeholder="GPS_latitude" readonly>
                </div>
                <div class="input-box col-md-4">
                    <span class="details">Polygon Area:</span>
                    <input type="text" class="form-control light-gray-placeholder" value="{{$parcels->area}}" name="area" id="polygon_area" placeholder="Polygon Area" readonly>
                </div>
                          ...
                          <div class="input-box col-md-4">
                            ...
                            <div class="d-flex align-items-center">
                                <select class="form-control custom-select light-gray-placeholder placeholder-text parcolor @error('parcolor') is-invalid @enderror" name="parcolor" id="selectparcolor" onchange="Selectparcolor()" aria-label="label select e">
                                  ...
                                  <option value="#009900" {{ old('parcolor') == '#009900' ? 'selected' : '' }}>Banana: #009900</option>
                                    <option value="Add" {{ old('parcolor') == 'Add' ? 'selected' : '' }}>Add</option>
                                </select>
          ...
          <div class="modal-body">
              ...
              <div class="form-row mt-3">
                  <div class="col">
                      ...
                      <input type="text" class="form-control"{{$parcels->latitude}} placeholder="Enter latitude" id="modal_latitude">
                  </div>
                  <div class="col">
                      <label for="modal_longitude" class="form-label">Longitude:</label>
                      <input type="text" class="form-control"{{$parcels->longitude}}  placeholder="Enter longitude" id="modal_longitude">
                  </div>
                  <div class="col">
                      <label for="modal_area">Area (sq meters):</label>
                      <input type="text" class="form-control light-gray-placeholder"{{$parcels->area}} placeholder="Area will be calculated" id="modal_area" readonly>
                  </div>
              </div>
              <div class="form-row mt-3">
                  <div class="col">
...
function initMap() {
    // Fetch initial data from Blade variables
    var initialLocation = {
        lat: parseFloat(document.getElementById('gps_latitude_0').value),
        lng: parseFloat(document.getElementById('gps_longitude_0').value)
    };
    ...
    // Set initial polygon if exists
    var initialArea = parseFloat(document.getElementById('polygon_area').value);
    if (!isNaN(initialArea) && initialArea > 0) {
        drawInitialPolygon(initialLocation, initialArea);
    }
    ...
    $('#drawPolygon').on('click', function() {
        ...
        var radius = Math.sqrt(desiredArea / Math.PI);
        var points = [];
        var numberOfSides = 6;
    ...
    // Update map center and marker on latitude/longitude input change
    ...
    // Set a marker and update latitude and longitude on map click
    ...
    // Function to draw initial polygon based on the area and center
    function drawInitialPolygon(center, area) {
...
$(document).ready(function() {
    ...
    $('#saveLocation').on('click', function() {
        ...
        $('#polygon_area').val($('#modal_area').val());
...
$(document).ready(function() {
    ...
    function fetchAgriDistricts() {
        $.ajax({
            url: '/admin-edit-parcel-boarders/{parcels}', // Replace with your route for fetching AgriDistricts
            method: 'GET',
            ...
            success: function(response) {
                ...
                if (typeof response === 'object' && Object.keys(response).length > 0) {
                    $('#districtSelect').empty().append('<option value="{{$parcels->agri_districts}}">{{$parcels->agri_districts}}</option>');
    ...
    function fetchBarangays(districtId, selectElement) {
        $.ajax({
            url: '/admin-edit-parcel-boarders/{parcels}', // Replace with your route for fetching Barangays
            method: 'GET',
            ...
            success: function(response) {
                ...
                $barangaySelect.append('<option value="{{$parcels->barangay_name}}">{{$parcels->barangay_name}}</option>');
    ...
    $(document).on('change', '#districtSelect', function() {
        ...
        if (districtId) {
            ...
            $(this).closest('.user-details').find('.barangaySelect')
                .empty().append('<option value="{{$parcels->barangay_name}}">{{$parcels->barangay_name}}</option><option value="add">Add New Barangay...</option>');
        }
    });
