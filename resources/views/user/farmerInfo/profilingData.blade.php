...
@section('user')
        ...
        <div class="card border-0 shadow rounded">
                    ...
                    <div class="row justify-content-center align-items-center">
                        <div class="col-md-4 text-center mb-4 mb-md-0">
                            <div class="profile-img">
                                ...
                                @if ($user->image)
                                    <img src="/agentimages/{{ $user->image }}" alt="Profile Image"
                                        class="img-fluid rounded-circle"style="border-radius: 50% !important;
            width: 99px;
            height: 90px;">
                                @else
                            ...
                            @php
                                $uniqueFarmers = collect($gpsData)->unique('users_id');
                            @endphp

                            @foreach ($uniqueFarmers as $data)
                    ...
                    <div class="mt-4 row">
                        <div class="col-md-6">
                            <h4>Farmer Info</h4>
                            <div class="collapse-header" data-bs-toggle="collapse" data-bs-target="#experienceDetails"
                                aria-expanded="false" aria-controls="experienceDetails">
                                    ...
                                    <div class="card-body">
                                        @foreach ($gpsData as $data)
                                            ...
                                            <p>
                                                ...
                                                <span
                                                    class="highlight-target">{{ ucwords(strtolower($data['place_of_birth'])) }}</span>
                                            </p>
                                            <p>
                                                <strong>Sex:</strong>
                                                <span
                                                    class="highlight-target">{{ ucwords(strtolower($data['sex'])) }}</span>
                                            </p>
                                            <p>
                                                <strong>Religion:</strong>
                                                <span
                                                    class="highlight-target">{{ ucwords(strtolower($data['religion'])) }}</span>
                                            </p>
                                            <p>
                                                <strong>Highest Formal Education:</strong>
                                                <span
                                                    class="highlight-target">{{ ucwords(strtolower($data['highest_formal_education'])) }}</span>
                                            </p>
                                            <p>
                                                <strong>Person with Disability:</strong>
                                                <span
                                                    class="highlight-target">{{ $data['person_with_disability'] ? 'Yes' : 'No' }}</span>
                                            </p>
                                            <p>
                                            ...
                                            <p>
                                                ...
                                                <span
                                                    class="highlight-target">{{ ucwords(strtolower($data['civilStatus'])) }}</span>
                                            </p>
                                            <p>
                                                <strong>Legal Spouse:</strong>
                                                <span
                                                    class="highlight-target">{{ ucwords(strtolower($data['name_legal_spouse'])) }}</span>
                                            </p>
                                            <p>
                                            ...
                                            <p>
                                                ...
                                                <span
                                                    class="highlight-target">{{ ucwords(strtolower($data['homeAddress'])) }}</span>
                                            </p>
                                            <p>
                                                <strong>Street:</strong>
                                                <span
                                                    class="highlight-target">{{ ucwords(strtolower($data['street'])) }}</span>
                                            </p>
                                            <p>
                                            ...
                                            <p>
                                                ...
                                                <span
                                                    class="highlight-target">{{ ucwords(strtolower($data['id_type'])) }}</span>
                                            </p>
                                            ...
                                            <p>
                                                ...
                                                <span
                                                    class="highlight-target">{{ ucwords(strtolower($data['orgName'])) }}</span>
                                            </p>
                                            ...
                                            <p>
                                                ...
                                                <span
                                                    class="highlight-target">{{ ucwords(strtolower($data['name_contact_person'])) }}</span>
                                            </p>
                                            <p>
                            ...
                            <div class="collapse-header" data-bs-toggle="collapse" data-bs-target="#skillsDetails"
                                aria-expanded="false" aria-controls="skillsDetails">
                                Production Details
                            </div>
                                            ...
                                            @foreach ($farmProfile->cropFarms as $cropFarm)
                                                ...
                                                @foreach ($cropFarm->lastProductionDatas as $lastProductionData)
                                                    ...
                                                    <p>
                                                        ...
                                                        <span
                                                            class="highlight-target">{{ $lastProductionData->seeds_typed_used }}</span>
                                                    </p>
                                                    <p>
                                                        <strong>Cropping No.:</strong>
                                                        <span
                                                            class="highlight-target">{{ $lastProductionData->cropping_no }}</span>
                                                    </p>
                                                    <p>
                                                        <strong>Seed Source:</strong>
                                                        <span
                                                            class="highlight-target">{{ $lastProductionData->seed_source }}</span>
                                                    </p>
                                                    <p>
                                                        <strong>Unit:</strong>
                                                        <span
                                                            class="highlight-target">{{ $lastProductionData->unit }}</span>
                                                    </p>
                                                    ...
                                                    <p>
                                                        ...
                                                        <span
                                                            class="highlight-target">{{ number_format($lastProductionData->no_of_fertilizer_used_in_bags, 2) }}</span>
                                                    </p>
                                                    <p>
                                                        <strong>No. of Pesticides Used (in L/Kg):</strong>
                                                        <span
                                                            class="highlight-target">{{ number_format($lastProductionData->no_of_pesticides_used_in_l_per_kg, 2) }}</span>
                                                    </p>
                                                    <p>
                                                        <strong>No. of Insecticides Used (in bags):</strong>
                                                        <span
                                                            class="highlight-target">{{ number_format($lastProductionData->no_of_insecticides_used_in_l, 2) }}</span>
                                                    </p>
                                                    ...
                                                    <p>
                                                        ...
                                                        <span
                                                            class="highlight-target">{{ number_format($lastProductionData->area_planted, 2) }}</span>
                                                    </p>
                                                    <p>
                                                        <strong>Date Planted:</strong>
                                                        <span
                                                            class="highlight-target">{{ \Carbon\Carbon::parse($lastProductionData->date_planted)->format('F d, Y') }}</span>
                                                    </p>
                                                    <p>
                                                        <strong>Date Harvested:</strong>
                                                        <span
                                                            class="highlight-target">{{ \Carbon\Carbon::parse($lastProductionData->date_harvested)->format('F d, Y') }}</span>
                                                    </p>
                                                    ...
                                                    <p>
                                                        ...
                                                        <span
                                                            class="highlight-target">{{ number_format($lastProductionData->yield_tons_per_kg, 2) }}</span>
                                                    </p>
                                                @endforeach
                                            @endforeach
                                        @endforeach
                        ...
                        <div class="col-md-6">
                            <h4>Farm</h4>
                            <div class="collapse-header" data-bs-toggle="collapse" data-bs-target="#projectsDetails"
                                aria-expanded="false" aria-controls="projectsDetails">
                                    ...
                                    <div class="card-body">
                                        @foreach ($gpsData as $data)
                                            ...
                                            <p>
                                                ...
                                                <span
                                                    class="highlight-target">{{ ucwords(strtolower($data['tenurial_status'])) }}</span>
                                            </p>
                                            <p>
                                            ...
                                            <p>
                                                ...
                                                <span
                                                    class="highlight-target">{{ number_format($data['NoYears'], 1) }}</span>
                                            </p>
                                            <p>
                                                <strong>Total Physical Area:</strong>
                                                <span
                                                    class="highlight-target">{{ number_format($data['totalPhysicalArea'], 1) }}</span>
                                            </p>
                                            <p>
                                                <strong>Total Area Cultivated:</strong>
                                                <span
                                                    class="highlight-target">{{ number_format($data['TotalCultivated'], 1) }}</span>
                                            </p>
                                            <p>
                                                <strong>Area Prone To:</strong>
                                                <span
                                                    class="highlight-target">{{ ucwords(strtolower($data['area_prone_to'])) }}</span>
                                            </p>
                                            <p>
                                                <strong>Ecosystem:</strong>
                                                <span
                                                    class="highlight-target">{{ ucwords(strtolower($data['ecosystem'])) }}</span>
                                            </p>
                                            ...
                                            <p>
                                                ...
                                                <span
                                                    class="highlight-target">{{ $data['rsba_registered'] ? 'Yes' : 'No' }}</span>
                                            </p>
                                            <p>
                                                <strong>PCIC Insured:</strong>
                                                <span
                                                    class="highlight-target">{{ $data['pcic_insured'] ? 'Yes' : 'No' }}</span>
                                            </p>
                                            <p>
                                                <strong>Government Assisted:</strong>
                                                <span
                                                    class="highlight-target">{{ $data['government_assisted'] ? 'Yes' : 'No' }}</span>
                                            </p>
                                            <p>
                                                <strong>Source Capital:</strong>
                                                <span
                                                    class="highlight-target">{{ ucwords(strtolower($data['source_of_capital'])) }}</span>
                                            </p>
                                            ...
                                            <p>
                                                ...
                                                <span
                                                    class="highlight-target">{{ ucwords(strtolower($data['cropName'])) }}</span>
                                            </p>
                                            <p>
                                            ...
                                            <p>
                                                ...
                                                <span
                                                    class="highlight-target">{{ number_format($data['croppingperYear']) }}</span>
                                            </p>
                                            <p>
                                                <strong>Planting Schedule (Wet Season):</strong>
                                                <span
                                                    class="highlight-target">{{ $data['planting_schedule_wetseason'] }}</span>
                                            </p>
                                            <p>
                                                <strong>Planting Schedule (Dry Season):</strong>
                                                <span
                                                    class="highlight-target">{{ $data['planting_schedule_dryseason'] }}</span>
                                            </p>
                                            ...
                                            <p>
                                                ...
                                                <span
                                                    class="highlight-target">{{ number_format($data['Yield'], 2) }}</span>
                                            </p>
                                        @endforeach <!-- End loop -->
                                    </div>
                                </div>
                            ...
                            <div class="collapse-header" data-bs-toggle="collapse"
                                data-bs-target="#certificationsDetails" aria-expanded="false"
                                aria-controls="certificationsDetails">
                                                    ...
                                                    @foreach ($farmProfile->cropFarms as $cropFarm)
                                                        @foreach ($cropFarm->variableCosts as $variableCostsData)
                                                            ...
                                                            <p>
                                                                ...
                                                                <span
                                                                    class="highlight-target">{{ ucwords(strtolower($variableCostsData->seed_name)) }}</span>
                                                            </p>
                                                            <p>
                                                                <strong>Unit:</strong>
                                                                <span
                                                                    class="highlight-target">{{ ucwords(strtolower($variableCostsData->unit)) }}</span>
                                                            </p>
                                                            <p>
                                                                <strong>Quantity:</strong>
                                                                <span
                                                                    class="highlight-target">{{ $variableCostsData->quantity }}</span>
                                                                <!-- Assuming you meant to display the number of hectares here -->
                                                            </p>
                                                            <p>
                                                                <strong>Unit price (Php):</strong>
                                                                <span
                                                                    class="highlight-target">{{ number_format($variableCostsData->unit_price, 2) }}</span>
                                                            </p>
                                                            <p>
                                                                <strong>Total Cost (Php):</strong>
                                                                <span
                                                                    class="highlight-target">{{ number_format($variableCostsData->total_seed_cost, 2) }}</span>
                                                            </p>
                                                        @endforeach
                                                    @endforeach
                                                @endforeach
                                                    ...
                                                    @foreach ($farmProfile->cropFarms as $cropFarm)
                                                        @foreach ($cropFarm->variableCosts as $variableCostsData)
                                                            ...
                                                            <p>
                                                                ...
                                                                <span
                                                                    class="highlight-target">{{ ucwords(strtolower($variableCostsData->labor_no_of_person)) }}</span>
                                                            </p>
                                                            <p>
                                                                <strong>Rate/Person:</strong>
                                                                <span
                                                                    class="highlight-target">{{ ucwords(strtolower($variableCostsData->rate_per_person)) }}</span>
                                                            </p>

                                                            <p>
                                                                <strong>Total Cost (Php):</strong>
                                                                <span
                                                                    class="highlight-target">{{ number_format($variableCostsData->total_labor_cost, 2) }}</span>
                                                            </p>
                                                        @endforeach
                                                    @endforeach
                                                @endforeach
                                                    ...
                                                    @foreach ($farmProfile->cropFarms as $cropFarm)
                                                        @foreach ($cropFarm->variableCosts as $variableCostsData)
                                                            ...
                                                            <p>
                                                                ...
                                                                <span
                                                                    class="highlight-target">{{ ucwords(strtolower($variableCostsData->name_of_fertilizer)) }}</span>
                                                            </p>
                                                            <p>
                                                                <strong>Type of Fertilizer:</strong>
                                                                <span
                                                                    class="highlight-target">{{ ucwords(strtolower($variableCostsData->type_of_fertilizer)) }}</span>
                                                            </p>
                                                            <p>
                                                                <strong>No. of Sacks:</strong>
                                                                <span
                                                                    class="highlight-target">{{ $variableCostsData->no_of_sacks }}</span>
                                                                <!-- Assuming you meant to display the number of hectares here -->
                                                            </p>
                                                            <p>
                                                                <strong>Cost/Sacks (Php):</strong>
                                                                <span
                                                                    class="highlight-target">{{ number_format($variableCostsData->unit_price_per_sacks, 2) }}</span>
                                                            </p>
                                                            <p>
                                                                <strong>Total Cost (Php):</strong>
                                                                <span
                                                                    class="highlight-target">{{ number_format($variableCostsData->total_cost_fertilizers, 2) }}</span>
                                                            </p>
                                                        @endforeach
                                                    @endforeach
                                                @endforeach
                                                    ...
                                                    @foreach ($farmProfile->cropFarms as $cropFarm)
                                                        @foreach ($cropFarm->variableCosts as $variableCostsData)
                                                            ...
                                                            <p>
                                                                ...
                                                                <span
                                                                    class="highlight-target">{{ ucwords(strtolower($variableCostsData->pesticide_name)) }}</span>
                                                            </p>
                                                            <p>
                                                                <strong>Type of Pesticide:</strong>
                                                                <span
                                                                    class="highlight-target">{{ ucwords(strtolower($variableCostsData->type_of_pesticides)) }}</span>
                                                            </p>

                                                            <p>
                                                                <strong> No. of l/kg:</strong>
                                                                <span
                                                                    class="highlight-target">{{ number_format($variableCostsData->no_of_l_kg, 2) }}</span>
                                                            </p>
                                                            <p>
                                                                <strong>Cost/Pesticides(Php):</strong>
                                                                <span
                                                                    class="highlight-target">{{ number_format($variableCostsData->unit_price_of_pesticides, 2) }}</span>
                                                            </p>
                                                            <p>
                                                                <strong>Total Cost (Php):</strong>
                                                                <span
                                                                    class="highlight-target">{{ number_format($variableCostsData->total_cost_pesticides, 2) }}</span>
                                                            </p>
                                                        @endforeach
                                                    @endforeach
                                                @endforeach
                                                    ...
                                                    @foreach ($farmProfile->cropFarms as $cropFarm)
                                                        @foreach ($cropFarm->variableCosts as $variableCostsData)
                                                            ...
                                                            <p>
                                                                ...
                                                                <span
                                                                    class="highlight-target">{{ ucwords(strtolower($variableCostsData->type_of_vehicle)) }}</span>
                                                            </p>

                                                            <p>
                                                                <strong>Total Cost (Php):</strong>
                                                                <span
                                                                    class="highlight-target">{{ number_format($variableCostsData->total_transport_delivery_cost, 2) }}</span>
                                                            </p>
                                                        @endforeach
                                                    @endforeach
                                                @endforeach
                                                    ...
                                                    @foreach ($farmProfile->cropFarms as $cropFarm)
                                                        @foreach ($cropFarm->variableCosts as $variableCostsData)
                                                            ...
                                                            <p>
                                                                ...
                                                                <span
                                                                    class="highlight-target">{{ number_format($variableCostsData->total_machinery_fuel_cost, 2) }}</span>
                                                            </p>

                                                            <p>
                                                                <strong>Total Cost (Php):</strong>
                                                                <span
                                                                    class="highlight-target">{{ number_format($variableCostsData->total_variable_cost, 2) }}</span>
                                                            </p>
                                                        @endforeach
                                                    @endforeach
                                                @endforeach
                    ...
                    <div class="mt-4 row">
                        <div class="col-md-6">
                            <h4>Fixed Cost</h4>
                            <div class="collapse-header" data-bs-toggle="collapse" data-bs-target="#fixedCostDetails"
                                aria-expanded="false" aria-controls="fixedCostDetails">
                                FixedCost Details
                            </div>
                                            ...
                                            @foreach ($farmProfile->cropFarms as $cropFarm)
                                                ...
                                                @foreach ($cropFarm->fixedCosts as $fixedCostsData)
                                                    <p>
                                                        ...
                                                        <span
                                                            class="highlight-target">{{ $fixedCostsData->Particular }}</span>
                                                    </p>
                                                    <p>
                                                        <strong>No. of Ha:</strong>
                                                        <span class="highlight-target">
                                                            {{ number_format($fixedCostsData->no_of_ha, 2) }}</span>
                                                    </p>
                                                    <p>
                                                        <strong>Cost per Ha:</strong>
                                                        <span
                                                            class="highlight-target">{{ number_format($fixedCostsData->cost_per_ha, 2) }}</span>
                                                    </p>
                                                    <p>
                                                        <strong>Total Fixed Cost:</strong>
                                                        <span
                                                            class="highlight-target">{{ number_format($fixedCostsData->total_fixed, 2) }}</span>
                                                    </p>
                                                @endforeach
                                            @endforeach
                                        @endforeach
                            ...
                            <div class="collapse-header" data-bs-toggle="collapse" data-bs-target="#machineDetails"
                                aria-expanded="false" aria-controls="machineDetails">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="collapse-header" data-bs-toggle="collapse" data-bs-target="#machineriesDetails"
                                aria-expanded="false" aria-controls="machineriesDetails">
                                                    ...
                                                    @foreach ($farmProfile->cropFarms as $cropFarm)
                                                        @foreach ($cropFarm->machineries as $machineriesData)
                                                            ...
                                                            <p>
                                                                ...
                                                                <span
                                                                    class="highlight-target">{{ ucwords(strtolower($machineriesData->plowing_machineries_used)) }}</span>
                                                            </p>
                                                            <p>
                                                                <strong>Ownership Status:</strong>
                                                                <span
                                                                    class="highlight-target">{{ ucwords(strtolower($machineriesData->plo_ownership_status)) }}</span>
                                                            </p>
                                                            <p>
                                                                <strong>No. of Plowing:</strong>
                                                                <span
                                                                    class="highlight-target">{{ $machineriesData->no_of_plowing }}</span>
                                                                <!-- Assuming you meant to display the number of hectares here -->
                                                            </p>
                                                            <p>
                                                                <strong>Cost/Plowing (Php):</strong>
                                                                <span
                                                                    class="highlight-target">{{ number_format($machineriesData->plowing_cost, 2) }}</span>
                                                            </p>
                                                            <p>
                                                                <strong>Total Cost (Php):</strong>
                                                                <span
                                                                    class="highlight-target">{{ number_format($machineriesData->plowing_cost_total, 2) }}</span>
                                                            </p>
                                                        @endforeach
                                                    @endforeach
                                                @endforeach
                                                    ...
                                                    @foreach ($farmProfile->cropFarms as $cropFarm)
                                                        @foreach ($cropFarm->machineries as $machineriesData)
                                                            ...
                                                            <p>
                                                                <strong>Machineries Used:</strong>
                                                                <span
                                                                    class="highlight-target">{{ ucwords(strtolower($machineriesData->harrowing_machineries_used)) }}</span>
                                                            </p>
                                                            <p>
                                                                <strong>Ownership Status:</strong>
                                                                <span
                                                                    class="highlight-target">{{ ucwords(strtolower($machineriesData->harro_ownership_status)) }}</span>
                                                            </p>
                                                            <p>
                                                                <strong>No. of Harrow:</strong>
                                                                <span
                                                                    class="highlight-target">{{ $machineriesData->no_of_harrowing }}</span>
                                                                <!-- Assuming you meant to display the number of hectares here -->
                                                            </p>
                                                            <p>
                                                                <strong>Cost/Harrow (Php):</strong>
                                                                <span
                                                                    class="highlight-target">{{ number_format($machineriesData->harrowing_cost, 2) }}</span>
                                                            </p>
                                                            <p>
                                                                <strong>Total Cost (Php):</strong>
                                                                <span
                                                                    class="highlight-target">{{ number_format($machineriesData->harrowing_cost_total, 2) }}</span>
                                                            </p>
                                                        @endforeach
                                                    @endforeach
                                                @endforeach
                                                ...
                                                @foreach ($farmProfiles as $farmProfile)
                                                    @foreach ($farmProfile->cropFarms as $cropFarm)
                                                        @foreach ($cropFarm->machineries as $machineriesData)
                                                            ...
                                                            <p>
                                                                <strong>Machineries Used:</strong>
                                                                <span
                                                                    class="highlight-target">{{ ucwords(strtolower($machineriesData->harvesting_machineries_used)) }}</span>
                                                            </p>
                                                            <p>
                                                                <strong>Ownership Status:</strong>
                                                                <span
                                                                    class="highlight-target">{{ ucwords(strtolower($machineriesData->harvest_ownership_status)) }}</span>
                                                            </p>
                                                            {{-- <p>
                                                    ...
                                                    <span class="highlight-target">{{ $machineriesData->no_of_harvesting }}</span> <!-- Assuming you meant to display the number of hectares here -->
                                                            ...
                                                            <p>
                                                                ...
                                                                <span
                                                                    class="highlight-target">{{ number_format($machineriesData->harvesting_cost, 2) }}</span>
                                                            </p>
                                                            <p>
                                                                <strong>Total Cost (Php):</strong>
                                                                <span
                                                                    class="highlight-target">{{ number_format($machineriesData->harvesting_cost_total, 2) }}</span>
                                                            </p>
                                                        @endforeach
                                                    @endforeach
                                                @endforeach
                                                    ...
                                                    @foreach ($farmProfile->cropFarms as $cropFarm)
                                                        @foreach ($cropFarm->machineries as $machineriesData)
                                                            ...
                                                            <p>
                                                                <strong>Machineries Used:</strong>
                                                                <span
                                                                    class="highlight-target">{{ ucwords(strtolower($machineriesData->postharvest_machineries_used)) }}</span>
                                                            </p>
                                                            <p>
                                                                <strong>Ownership Status:</strong>
                                                                <span
                                                                    class="highlight-target">{{ ucwords(strtolower($machineriesData->postharv_ownership_status)) }}</span>
                                                            </p>

                                                            <p>
                                                                <strong>Total Cost (Php):</strong>
                                                                <span
                                                                    class="highlight-target">{{ number_format($machineriesData->post_harvest_cost_total, 2) }}</span>
                                                            </p>
                                                        @endforeach
                                                    @endforeach
                                                @endforeach
                                                ...
                                                @foreach ($farmProfiles as $farmProfile)
                                                    @foreach ($farmProfile->cropFarms as $cropFarm)
                                                        @foreach ($cropFarm->machineries as $machineriesData)
                                                            ...
                                                            <span
                                                                class="highlight-target">{{ ucwords(strtolower($machineriesData->total_cost_for_machineries)) }}</span>
                                                            </p>
                                                        @endforeach
                                                    @endforeach
                                                @endforeach
                            ...
                            <div class="collapse-header" data-bs-toggle="collapse" data-bs-target="#GrossIncome"
                                aria-expanded="false" aria-controls="GrossIncome">
                            ...
                            <div class="collapse-header" data-bs-toggle="collapse" data-bs-target="#croppingDetails"
                                aria-expanded="false" aria-controls="croppingDetails">
            ...
            <div class="row mr-4 mb-4">
                <div class="col-md-12 text-end">
                    ...
                    <button type="button" class="btn btn-outline-success me-2" onclick="printProfile()">Print
                        Profile</button>
                    <button type="button" class="btn btn-outline-success" data-bs-toggle="modal"
                        data-bs-target="#farmerReportModal">
                        Farmer Reports
                    </button>
                </div>
            </div>
    ...
    <!-- Modal Structure -->
    <div class="modal fade" id="farmerReportModal" tabindex="-1" aria-labelledby="farmerReportModalLabel"
    aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body" id="modalContentToPrint" style="max-height: 600px; overflow-y: auto;">
                ...
                <div class="profile-head text-center mt-5">
                    @php
                        $uniqueFarmers = collect($gpsData)->unique('farmerName');
                    @endphp
                                ...
                                @foreach ($farmProfile->cropFarms as $cropFarm)
                                    @foreach ($cropFarm->lastProductionDatas as $productionData)
                                        @php
                                            ...
                                            $cropName = $cropFarm->crop_name;
                                            $areaPlanted = $productionData->area_planted;
                                            $yieldPerAreaPlanted = $areaPlanted > 0 ? $yieldTonsKg / $areaPlanted : 0;
                                        @endphp

                                        <tr class="table-secondary text-center" style="font-weight: bold; font-size: 1.1em;">
                                            <td colspan="2">
                                        ...
                                        <tr>
                                            ...
                                            <td  id="totalAreaPlanted">{{ number_format($yieldTonsKg, 2) }} kg</td>
                                        </tr>
                                        <tr>
                                            <td class="text-black">Yield per Area Planted</td>
                                            <td  id="totalAreaPlanted">{{ number_format($yieldPerAreaPlanted, 2) }} kg/ha</td>
                                        </tr>

                                        @foreach ($cropFarm->variableCosts as $variableCostsData)
                                            <tr>
                                                <td class="text-black">Total Cost</td>
                                                <td  id="totalAreaPlanted">₱{{ number_format($variableCostsData->total_variable_cost, 2) }}</td>
                                            </tr>
                                            @php
                                                $avgCost = $areaPlanted > 0 ? $variableCostsData->total_variable_cost / $areaPlanted : 0;
                                            @endphp
                                            <tr>
                                                <td class="text-black">Average Cost/Area Planted</td>
                                                <td  id="totalAreaPlanted">₱{{ number_format($avgCost, 2) }}/ha</td>
                                            </tr>
                                        @endforeach
                                    @endforeach
                                @endforeach
    ...
    <style>
        ...
        #yieldPerAreaPlanted,
        #yieldTonsKg,
        #totalCostForCropping,
        #averageCostPerAreaPlantedForCropping {
            font-weight: 500;
            color: #239e29;
        }
        ...
        .collapse-header {
            ...
            /* Add border to match card styling */
        ...
        .card-body {
            padding: 77px;
            /* Adjusted padding for the card body */
            border-radius: 0.25rem;
            /* Rounded corners */
        }
        ...
        .card {
            margin-top: 77px;
            /* Space between card and previous elements */
        }
    ...
    <style>
        ...
        @media print {
            ...
            .no-print {
                display: none;
                /* Add this class to elements you want to hide */
            }
        ...
        .card-body {
            ...
            /* Adjust padding for a more compact fit */
        }
        ...
        .chart-value-container {
            ...
            /* Center align items */
            margin-top: 10px;
            /* Space between chart and values */
        ...
        .chart-value-container div {
            margin: 2px 0;
            /* Space between individual values */
            font-size: 14px;
    ...
    <script>
        ...
        function printProfile() {
            ...
            const elementsToHighlight = profileElement.querySelectorAll(
            '.highlight-target'); // Adjust the selector as needed
                ...
                success: function(response) {
                    ...
                    if (response && response.formattedData) {
                        ...
                        const options = {
                            ...
                            colors: ['#009e2e', '#FFCE56', '#e3004d', '#4BC0C0', '#9966FF',
                                '#FF9F40', '#ff0000'
                            ],
                            responsive: [{
                                breakpoint: 480,
                            ...
                            dataLabels: {
                                ...
                                formatter: function(val, opts) {
                                    const index = opts
                                    .seriesIndex; // Get index of the current slice
                                    const actualValue = cropData.data[
                                    index]; // Get the actual value for this slice
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    if (response && response.formattedIncomeData) {
                        ...
                        const capitalizedLabels = incomeData.labels.map(label => capitalizeFirstLetter(
                            label));
                        ...
                        // Initialize the chart using ApexCharts
                        const chart = new ApexCharts(document.querySelector("#grossIncomeChart"),
                            options);
                        chart.render();
                    } else {
                        console.error('No data returned from the server.');
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    var options = {
                        ...
                        colors: ['#009e2e', '#FFCE56', '#e3004d', '#4BC0C0', '#9966FF', '#FF9F40',
                            '#ff0000'
                        ], // Specify your colors
                    };
                        ...
                        if (response.success) {
                            ...
                            $.each(farmProfiles, function(index, farmProfile) {
                                ...
                                $.each(cropFarms, function(index, cropFarm) {
                                    let totalAreaPlanted = cropFarm
                                        .total_area_planted ?? 'N/A';
                                    let variableCosts = cropFarm.variableCosts[
                                        0]?.total_variable_cost || 'N/A';
                                    let lastProduction = cropFarm
                                        .lastProductionDatas[0] || {};
                                    let croppingNo = lastProduction
                                        .cropping_no || 'N/A';
                                    let harvestDate = lastProduction
                                        .harvest_date ? new Date(lastProduction
                                            .harvest_date)
                                    .toLocaleDateString() : 'N/A';
                                    let yieldTonsKg = lastProduction
                                        .yield_tons_kg || 'N/A';

                                    let averageCostPerAreaPlanted = (
                                            totalAreaPlanted > 0 &&
                                            variableCosts > 0) ?
                                        (variableCosts / totalAreaPlanted)
                                        .toFixed(2) : 'N/A';
