...
<script>
    ...
    $('#viewFarmersBtn').on('click', function() {
        ...
        $.ajax({
            url: '/user/dashboard', // Update this with the correct route
            method: 'GET',
...
$(document).ready(function () {
    ...
    function fetchFarmers(page = 1) {
        $.ajax({
            url: '/user/dashboard', // Replace with your actual API endpoint
            method: 'GET',
            data: {
...
$(document).ready(function() {
    ...
    function fetchAndDisplayChart() {
        $.ajax({
            url: '/user/dashboard', // Adjust to your Laravel route
...
$(document).ready(function () {
    ...
    function fetchTotalCost(cropName, district) {
        $.ajax({
            url: '/user/dashboard', // Update with your actual endpoint
            method: 'GET',
            data: {
                crop_name: cropName,
                district: district
...
$(document).ready(function() {
    ...
    function fetchData() {
        ...
        $.ajax({
            url: '/user/dashboard', // URL of the API endpoint
            type: 'GET',
            dataType: 'json',
            data: {
