            ...
            <div id="collapseFarmProfile" class="collapse show" aria-labelledby="headingFarmProfile" data-parent="#accordionFarmProfile">
                <div class="card-body">
                 ...
                 --}}
                        ...
                        {{-- --}} <input type="hidden" class="form-control light-gray-placeholder users_id" name="users_id" value="{{$polygons->users_id}}">
                            <div class="input-box col-md-4">
                              <span class="details">Polygon Name:</span>
                              <input type="text" class="form-control light-gray-placeholder poly_name" value="{{$polygons->poly_name}}" name="poly_name" placeholder="Enter Polygon Name" id="rice_farm_address_0" onkeypress="return blockSymbolsAndNumbers(event)">
                          </div>
                              ...
                              <div class="input-box col-md-4">
                                ...
                                <select class="form-control barangaySelect" name="barangay_name">
                            ...
                            <div class="input-box col-md-4">
                                <span class="details">Point 1 Latitude:</span>
                                <input type="number" class="form-control light-gray-placeholder verone_latitude" value="{{$polygons->verone_latitude}}" name="verone_latitude" placeholder="Enter Point 1 Latitude" id="verone_latitude">
                            </div>
                            <div class="input-box col-md-4">
                              <span class="details">Point 1 Longitude:</span>
                              <input type="number" class="form-control light-gray-placeholder verone_longitude" value="{{$polygons->verone_longitude}}" name="verone_longitude" placeholder="Enter Point 1 Longitude" id="verone_longitude">
                          </div>

                          <div class="input-box col-md-4">
                            <span class="details">Point 2 Latitude:</span>
                            <input type="number" class="form-control light-gray-placeholder vertwo_latitude" value="{{$polygons->vertwo_latitude}}" name="vertwo_latitude" placeholder="Enter Point 2 Latitude" id="verone_longitude">
                        </div>

                        <div class="input-box col-md-4">
                          <span class="details">Point 2 Longitude:</span>
                          <input type="number" class="form-control light-gray-placeholder vertwo_longitude" value="{{$polygons->vertwo_longitude}}" name="vertwo_longitude" placeholder="Enter Point 2 Longitude" id="verone_longitude">
                      </div>
                      <div class="input-box col-md-4">
                        <span class="details">Point 3 Latitude:</span>
                        <input type="number" class="form-control light-gray-placeholder verthree_latitude" value="{{$polygons->verthree_latitude}}"  name="verthree_latitude" placeholder="Enter Point 3 Latitude" id="verone_longitude">
                    </div>

                    <div class="input-box col-md-4">
                      <span class="details">Point 3 Longitude:</span>
                      <input type="number" class="form-control light-gray-placeholder verthree_longitude" value="{{$polygons->verthree_longitude}}"  name="verthree_longitude" placeholder="Enter Point 3 Longitude" id="verone_longitude">
                  </div>
                  <div class="input-box col-md-4">
                    <span class="details">Point 4 Latitude:</span>
                    <input type="number" class="form-control light-gray-placeholder vertfour_latitude" value="{{$polygons->vertfour_latitude}}" name="vertfour_latitude" placeholder="Enter Point 4 Latitude" id="verone_longitude">
                </div>

                <div class="input-box col-md-4">
                  <span class="details">Point 4 Longitude:</span>
                  <input type="number" class="form-control light-gray-placeholder vertfour_longitude" value="{{$polygons->vertfour_longitude}}" name="vertfour_longitude" placeholder="Enter Point 3 Longitude" id="verone_longitude">
              </div>
                     ...
                     <br>
                       <div class="user-details">
                          ...
                          <div class="input-box col-md-4">
                            <span class="details">Point 5 Latitude:</span>
                            <input type="number" class="form-control light-gray-placeholder verfive_latitude" value="{{$polygons->verfive_latitude}}"  name="verfive_latitude" placeholder="Enter Point 5 Latitude" id="verone_longitude">
                        </div>

                        <div class="input-box col-md-4">
                          <span class="details">Point 5 Longitude:</span>
                          <input type="number" class="form-control light-gray-placeholder verfive_longitude" value="{{$polygons->verfive_longitude}}" name="verfive_longitude" placeholder="Point 5 Longitude" id="verone_longitude">
                      </div>

                      <div class="input-box col-md-4">
                            <span class="details">Point 6 Latitude:</span>
                            <input type="number" class="form-control light-gray-placeholder versix_latitude" value="{{$polygons->versix_latitude}}" name="versix_latitude" placeholder="Enter Point 6 Latitude" id="verone_longitude">
                        </div>

                        <div class="input-box col-md-4">
                          <span class="details">Point 6 Longitude:</span>
                          <input type="number" class="form-control light-gray-placeholder versix_longitude"value="{{$polygons->versix_longitude}}" name="versix_longitude" placeholder="Point 6 Longitude" id="verone_longitude">
                      </div>

                      <div class="input-box col-md-4">
                        <span class="details">Point 7 Latitude:</span>
                        <input type="number" class="form-control light-gray-placeholder verseven_latitude"value="{{$polygons->verseven_latitude}}" name="verseven_latitude" placeholder="Enter Point 7 Latitude" id="verone_longitude">
                    </div>

                    <div class="input-box col-md-4">
                      <span class="details">Point 7 Longitude:</span>
                      <input type="number" class="form-control light-gray-placeholder verseven_longitude"value="{{$polygons->verseven_longitude}}" name="verseven_longitude" placeholder="Enter Point 7 Longitude" id="verone_longitude">
                  </div>

                  <div class="input-box col-md-4">
                    <span class="details">Point 8 Longitude:</span>
                    <input type="number" class="form-control light-gray-placeholder vereight_latitude"value="{{$polygons->vereight_latitude}}" name="vereight_latitude" placeholder="Enter Point 8 Longitude" id="verone_longitude">
                </div>

                <div class="input-box col-md-4">
                  <span class="details">Point 8 Longitude:</span>
                  <input type="number" class="form-control light-gray-placeholder verteight_longitude" value="{{$polygons->verteight_longitude}}"name="verteight_longitude" placeholder=" Enter Point 8 Longitude" id="verone_longitude">
              </div>
                            <div class="input-box col-md-4">
                                <span class="details">GPS Longitude:</span>
                                <input type="text" class="form-control light-gray-placeholder longitude"  value="{{$polygons->latitude}}" name="longitude" id="gps_longitude_0" placeholder="GPS_longitude" readonly >
                              </div>
                              <div class="input-box col-md-4">
                                <span class="details">GPS Latitude:</span>
                                <input type="text" class="form-control light-gray-placeholder latitude"  value="{{$polygons->longitude}}" name="latitude" id="gps_latitude_0"placeholder="GPS_latitude" readonly>
                              </div>
                              <div class="input-box col-md-4">
                                <span class="details">Polygon Area:</span>
                                <input type="text" class="form-control light-gray-placeholder"  value="{{$polygons->area}}" name="area" id="polygon_area" placeholder="Polygon Area" readonly>
                            </div>
                          ...
                          <div class="input-box col-md-4">
                            ...
                            <div class="d-flex align-items-center">
                                <select class="form-control custom-select light-gray-placeholder placeholder-text strokecolor @error('strokecolor') is-invalid @enderror" name="strokecolor" id="strokecolor" onchange="Selectparcolor()" aria-label="label select e">
                                  ...
                                  <option value="#ff0000" {{ old('strokecolor') == '#ff0000' ? 'selected' : '' }}>Vitali: #ff0000</option>
                                    <option value="Add" {{ old('strokecolor') == 'Add' ? 'selected' : '' }}>Add</option>
                                </select>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-row mt-3">
                  ...
                  <div class="col">
                      <label for="modal_area">Area (sq meters):</label>
                      <input type="text" class="form-control light-gray-placeholder" placeholder="Area will be calculated" id="modal_area" readonly>
                  </div>
                </div>
                <div class="form-row mt-3">
                  <div class="col">
                      <label for="input_area">Desired Area (sq meters):</label>
                      <input type="text" class="form-control" placeholder="Enter area" id="input_area">
                  </div>
                  <div class="col">
                      <button type="button" class="btn btn-primary" id="drawPolygon">Draw Polygon</button>
                  </div>
                  <div class="col">
                      <button type="button" class="btn btn-danger" id="removePolygon">Remove Polygon</button>
                  </div>
              </div>
...
<script type="text/javascript">
        ...
        function initMap() {
            ...
            google.maps.event.addListener(drawingManager, 'overlaycomplete', function(event) {
                if (event.type === google.maps.drawing.OverlayType.POLYGON) {
                    ...
                    var area = google.maps.geometry.spherical.computeArea(currentPolygon.getPath());
                    document.getElementById('polygon_area').value = area.toFixed(2); // Update area on the main form
                    document.getElementById('modal_area').value = area.toFixed(2); // Update area in the modal

                    var path = currentPolygon.getPath().getArray();
                    var latLng = path[0];
                    $('#modal_latitude').val(latLng.lat());
                    $('#modal_longitude').val(latLng.lng());
                }
            });

            // Draw a polygon based on user input area
            $('#drawPolygon').on('click', function() {
                var desiredArea = parseFloat($('#input_area').val());

                if (isNaN(desiredArea) || desiredArea <= 0) {
                    alert('Please enter a valid area.');
                    return;
                }

                // Define a central point to start the polygon
                var center = { lat: 6.9214, lng: 122.0790 }; // Example central point
                var radius = Math.sqrt(desiredArea / Math.PI); // Approximate radius in meters
                var points = [];
                var numberOfSides = 6; // Number of sides of the polygon

                for (var i = 0; i < numberOfSides; i++) {
                    var angle = i * (2 * Math.PI / numberOfSides);
                    var dx = radius * Math.cos(angle);
                    var dy = radius * Math.sin(angle);
                    var point = google.maps.geometry.spherical.computeOffset(center, Math.sqrt(dx * dx + dy * dy), google.maps.geometry.spherical.computeHeading(center, { lat: center.lat + dx, lng: center.lng + dy }));
                    points.push(point);
                }
                ...
                $('#polygon_area').val(area.toFixed(2));

                // Save the polygon as the currentPolygon
                currentPolygon = polygon;
            });

            // Remove the current polygon from the map
            $('#removePolygon').on('click', function() {
                if (currentPolygon) {
                    currentPolygon.setMap(null);
                    currentPolygon = null;
                    $('#modal_area').val('');
        ...
        $(document).ready(function() {
            ...
            $('#mapModal').on('shown.bs.modal', function() {
                if (currentPolygon) {
                    currentPolygon.setMap(map); // Re-add the current polygon to the map
                }
            ...
            $('#saveLocation').on('click', function() {
                // Save the latitude, longitude, and area to the main input fields
                var lat = $('#modal_latitude').val();
                var lng = $('#modal_longitude').val();
                $('#gps_latitude_0').val(lat);
                $('#gps_longitude_0').val(lng);
                $('#polygon_area').val($('#modal_area').val()); // Update area on the main form
...
//         // Check if selectMember value is 1 to show organization input
...
//         }
//     } else {
//         barangayInput.style.display = "none"; // Hide barangay input if no district is selected
//         organizationInput.style.display = "none"; // Hide organization input if no district is selected
//     }
// }
...
//     var agriDistrict = '{{ $agri_districts }}'; // Ensure this is dynamically set
...
$(document).ready(function() {
    ...
    function fetchAgriDistricts() {
        $.ajax({
            url: '/admin-edit-polygon/{polygons}', // Replace with your route for fetching AgriDistricts
            method: 'GET',
            ...
            success: function(response) {
                ...
                if (typeof response === 'object' && Object.keys(response).length > 0) {
                    $('#districtSelect').empty().append('<option value="{{$polygons->agri_districts}}">{{$polygons->agri_districts}}</option>');
