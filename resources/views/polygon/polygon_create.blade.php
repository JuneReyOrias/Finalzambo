                 ...
                 --}}
                        ...
                        {{-- --}} <input type="hidden" class="form-control light-gray-placeholder users_id" name="users_id" value="{{$userId}}">
                            <div class="input-box col-md-4">
                              ...
                              <input type="text" class="form-control light-gray-placeholder poly_name"name="poly_name" placeholder="Enter Polygon Name" id="rice_farm_address_0" onkeypress="return blockSymbolsAndNumbers(event)">
                          </div>
                            ...
                            <div class="input-box col-md-4">
                                ...
                                <input type="number" class="form-control light-gray-placeholder verone_latitude"name="verone_latitude" placeholder="Enter Point 1 Latitude" id="verone_latitude">
                            </div>
                            <div class="input-box col-md-4">
                              <span class="details">Point 1 Longitude:</span>
                              <input type="number" class="form-control light-gray-placeholder verone_longitude"name="verone_longitude" placeholder="Enter Point 1 Longitude" id="verone_longitude">
                          </div>

                          <div class="input-box col-md-4">
                            <span class="details">Point 2 Latitude:</span>
                            <input type="number" class="form-control light-gray-placeholder vertwo_latitude"name="vertwo_latitude" placeholder="Enter Point 2 Latitude" id="verone_longitude">
                        </div>

                        <div class="input-box col-md-4">
                          <span class="details">Point 2 Longitude:</span>
                          <input type="number" class="form-control light-gray-placeholder vertwo_longitude"name="vertwo_longitude" placeholder="Enter Point 2 Longitude" id="verone_longitude">
                      </div>
                      <div class="input-box col-md-4">
                        <span class="details">Point 3 Latitude:</span>
                        <input type="number" class="form-control light-gray-placeholder verthree_latitude"name="verthree_latitude" placeholder="Enter Point 3 Latitude" id="verone_longitude">
                    </div>

                    <div class="input-box col-md-4">
                      <span class="details">Point 3 Longitude:</span>
                      <input type="number" class="form-control light-gray-placeholder verthree_longitude"name="verthree_longitude" placeholder="Enter Point 3 Longitude" id="verone_longitude">
                  </div>
                  <div class="input-box col-md-4">
                    <span class="details">Point 4 Latitude:</span>
                    <input type="number" class="form-control light-gray-placeholder vertfour_latitude"name="vertfour_latitude" placeholder="Enter Point 4 Latitude" id="verone_longitude">
                </div>

                <div class="input-box col-md-4">
                  <span class="details">Point 4 Longitude:</span>
                  <input type="number" class="form-control light-gray-placeholder vertfour_longitude"name="vertfour_longitude" placeholder="Enter Point 3 Longitude" id="verone_longitude">
              </div>
                     ...
                     <br>
                       <div class="user-details">
                          ...
                          <div class="input-box col-md-4">
                            ...
                            <input type="number" class="form-control light-gray-placeholder verfive_latitude"name="verfive_latitude" placeholder="Enter Point 5 Latitude" id="verone_longitude">
                        </div>

                        <div class="input-box col-md-4">
                          <span class="details">Point 5 Longitude:</span>
                          <input type="number" class="form-control light-gray-placeholder verfive_longitude"name="verfive_longitude" placeholder="Point 5 Longitude" id="verone_longitude">
                      </div>

                      <div class="input-box col-md-4">
                            <span class="details">Point 6 Latitude:</span>
                            <input type="number" class="form-control light-gray-placeholder versix_latitude"name="versix_latitude" placeholder="Enter Point 6 Latitude" id="verone_longitude">
                        </div>

                        <div class="input-box col-md-4">
                          <span class="details">Point 6 Longitude:</span>
                          <input type="number" class="form-control light-gray-placeholder versix_longitude"name="versix_longitude" placeholder="Point 6 Longitude" id="verone_longitude">
                      </div>

                      <div class="input-box col-md-4">
                        <span class="details">Point 7 Latitude:</span>
                        <input type="number" class="form-control light-gray-placeholder verseven_latitude"name="verseven_latitude" placeholder="Enter Point 7 Latitude" id="verone_longitude">
                    </div>

                    <div class="input-box col-md-4">
                      <span class="details">Point 7 Longitude:</span>
                      <input type="number" class="form-control light-gray-placeholder verseven_longitude"name="verseven_longitude" placeholder="Enter Point 7 Longitude" id="verone_longitude">
                  </div>

                  <div class="input-box col-md-4">
                    <span class="details">Point 8 Longitude:</span>
                    <input type="number" class="form-control light-gray-placeholder vereight_latitude"name="vereight_latitude" placeholder="Enter Point 8 Longitude" id="verone_longitude">
                </div>

                <div class="input-box col-md-4">
                  <span class="details">Point 8 Longitude:</span>
                  <input type="number" class="form-control light-gray-placeholder verteight_longitude"name="verteight_longitude" placeholder=" Enter Point 8 Longitude" id="verone_longitude">
              </div>
                            <div class="input-box col-md-4">
                              ...
                              <div class="input-box col-md-4">
                                ...
                                <input type="text" class="form-control light-gray-placeholder" name="area" id="polygon_area" placeholder="Polygon Area" readonly>
                            </div>
