        ...
        <div class="col-lg-4">
          <div class="card mb-4">
            <div class="card-body text-center">
              <!-- Display agent image or default profile -->
              @if ($agent->image)
                <img src="/agentimages/{{$agent->image}}" name="image" id="showImage" alt="profile" class="rounded-circle img-fluid" style="width: 150px; height: 140px;">
              @else
            ...
            <div class="card-body">
              <form action{{ url('Agentupdate') }} method="post" enctype="multipart/form-data">
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-9">
                    <input type="text" class="form-control" name="name" autocomplete="off" value="{{$agent->first_name.' '.$agent->last_name}}"@readonly(true)>
                  </div>
                </div>
                <hr>
                <div class="row">
                  ...
                  <div class="col-sm-9">
                    <input type="email" class="form-control" name="email" id="exampleInputEmail1" value="{{$agent->email}}" readonly>
                  </div>
                </div>
                <hr>
                <div class="row">
                  ...
                  <div class="col-sm-9">
                    <input type="text" class="form-control"name="district" id="district" autocomplete="off" value="{{$agent->district}}"@readonly(true)>
                  </div>
                </div>
                <hr>
                <div class="row">
                  ...
                  <div class="col-sm-9">
                    <input type="text" class="form-control"name="role" id="role" autocomplete="off" value="{{$agent->role}}" readonly>
                  </div>
                </div>
                <hr>
  {{--   
