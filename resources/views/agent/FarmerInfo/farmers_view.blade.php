...
function ArchiveData(id) {
    $.ajax({
        url: `/agent-edit-farmers/${id}`, // URL to fetch data
        type: 'GET',
        dataType: 'json',
                    ...
                    $('#personal-info-list').append(`
                        <tr class="new-row">
                            ...
                            <td class="custom-cell">
                                <a href="/agent-view-farms/${info.id}" title="View farm">
                                ...
                                <a href="/agent-edit-farmers/${info.id}" title="Edit farmer">
                                    <button class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></button>
                                </a>
                                <form action="/agent-delete-farmers/${info.id}" method="post" style="display:inline">
                                    {{ csrf_field() }}
