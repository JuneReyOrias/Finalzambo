                    ...
                    <div class="tabs">
                        ...
                        <div class="tab">
                            ...
                            <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                                ...
                                <a href="{{route('agent.FarmInfo.crudFarm.add',$personalinfos->id)}}" title="Add farm">
                            ...
                            <!-- Pagination links -->
                              <ul class="pagination">
                                ...
                                <div class="button-container mt-3 d-flex justify-content-between">
                                    <a href="{{ route('agent.FarmerInfo.farmers_view') }}" button type="button" class="btn btn-primary" onclick="goBack()">Back</button></a>
...
function FarmData(id) {
    $.ajax({
        url: '/agent-edit-farms/' + id, // Adjust the URL to match your route
        type: 'GET',
        dataType: 'json',
