                                        ...
                                        <div class="card-forms border rounded">
                                            ...
                                            <div class="card-forms border rounded">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    @endif
                                                <div class="content">
                                    <form action{{'UpdatedFixedCost'}} method="POST">
                                        @csrf
            ...
            <div id="collapseFarmProfile" class="collapse show" aria-labelledby="headingFarmProfile" data-parent="#accordionFarmProfile">
                <div class="card-body">
                            ...
                            <div class="user-details">
                                ...
                                <div class="input-box col-md-4">
                                  ...
                                  <select class="form-control crops_farms_id" name="crops_farms_id" id="crop_name">
                                    <option value="{{$fixedData->crops_farms_id}}">{{$fixedData->cropFarm->crop_name}}</option>
                         ...
                         <div class="input-box col-md-4">
                            ...
                            <div class="d-flex align-items-center">
                                <select class="form-control custom-select light-gray-placeholder particular @error('particular') is-invalid @enderror" 
                                        ...
                                        <option value="{{$fixedData->particular}}">{{$fixedData->particular}}</option>
                        ...
                        <div class="input-box col-md-4">
                            ...
                            value="{{$fixedData->no_of_ha}}"    name="no_of_ha" id="no_of_ha" placeholder="Enter No. of Has" value="{{ old('no_of_ha') }}">
                        ...
                        <div class="input-box col-md-4">
                            ...
                            <input type="number" class="form-control light-gray-placeholder cost-has @error('gross_income_rice') is-invalid @enderror"
                             value="{{number_format($fixedData->cost_per_ha,2)}}"   name="cost_per_ha" id="cost_per_ha"placeholder="Enter Cost/Has" value="{{ old('cost_per_ha') }}">
                        ...
                        <div class="input-box col-md-4">
                            ...
                            <input type="number" class="form-control light-gray-placeholder total-amount @error('gross_income_rice') is-invalid @enderror"
                             value="{{$fixedData->total_amount}}"  name="total_amount" id="total_amount" placeholder="Enter total amount"  value="{{ old('total_amount') }}">
                            @error('gross_income_rice')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
