                                    ...
                                    <div class="page-content">
                                        <div class="card-forms border rounded">
                                            ...
                                            <div class="card-forms border rounded">
                                                ...
                                                @endif
                                                <div class="content">
                                    <form  method="POST" action{{url('UpdatedCrop')}}>
                                        @csrf
    ...
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          ...
          <a href="{{route('agent.FarmerInfo.crops_view',$cropfarm->id)}}" class="btn btn-success">Crop View</a>
        </div>
      </div>
    </div>
  </div>
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    $.ajax({
        url: '/agent-edit-farmer-crops/{farmData}',
        method: 'GET',
        data: { type: 'crops' },
