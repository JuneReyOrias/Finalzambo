                     ...
                     <div class="card-forms border rounded">
                         ...
                         <div class="card-forms border rounded">
                            ...
                            <div class="card-body">
                                 ...
                                 <div class="content">
                                    <form  method="POST" action{{url('StoreFarmers')}}>
                                        @csrf
                                    ...
                                    <div class="step active farmer-info" id="step1">
                                        ...
                                        <div class="user-details">
                                            ...
                                            <div class="input-box col-md-4">
                                                ...
                                                <input type="text" id="firstName" class="form-control light-gray-placeholder first_name"value="{{$personalinfos->first_name}}" name="first_name" placeholder="Enter First Name" value="{{ old('first_name') }}">
                                                <div id="firstNameError" class="invalid-feedback"></div>
                                            </div>
                                            <div class="input-box col-md-4">
                                                <span class="details">Middle Name</span>
                                                <input type="text" id="middleName" class="form-control light-gray-placeholder middle_name"value="{{$personalinfos->middle_name}}" name="middle_name" placeholder="Enter Middle Name" value="{{ old('middle_name') }}">
                                                <div id="middleNameError" class="invalid-feedback"></div>
                                            </div>
                                            <div class="input-box col-md-4">
                                                <span class="details">Last Name</span>
                                                <input type="text" id="lastName" class="form-control light-gray-placeholder last_name"value="{{$personalinfos->last_name}}" name="last_name" placeholder="Enter Last Name" value="{{ old('last_name') }}">
                                            ...
                                            <div class="input-box col-md-4">
                                                ...
                                                <div class="d-flex align-items-center">
                                                    <select class="form-control custom-select extension_name light-gray-placeholder" id="selectExtendName" name="extension_name">
                                                        <option value="{{$personalinfos->extension_name}}">{{$personalinfos->extention_name}}</option>
                                            ...
                                            <div class="input-box col-md-4">
                                                ...
                                                <input type="text" id="mothersMaidenName" class="form-control light-gray-placeholder mothers_maiden_name"value="{{$personalinfos->mothers_maiden_name}}" name="mothers_maiden_name" placeholder="Mother's Maiden Name" value="{{ old('mothers_maiden_name') }}" required>
                                                <div id="mothers_maiden_name_error" class="invalid-feedback"></div>
                                            </div>
                                            <div class="input-box col-md-4">
                                                <span class="details">Date of Birth</span>
                                                <input type="text" id="datepicker" class="form-control light-gray-placeholder date_of_birth"value="{{$personalinfos->date_of_birth}}" name="date_of_birth" placeholder="Date of Birth" value="{{ old('date_of_birth') }}" required>
                                        ...
                                        <div class="step farmer-info" id="step2">
                                         ...
                                         <h3>b. Contact & Demographic Info</h3>
                                          <div class="user-details">
                                            ...
                                            <input type="text" name="home_address" id="home_address" class="form-control home_address light-gray-placeholder @error('home_address') is-invalid @enderror" value="{{$personalinfos->home_address}}" name="home_address" placeholder="Street" autocomplete="new-password" value="{{ old('home_address') }}"onkeypress="return blockSymbolsAndNumbers(event)">
                                            @error('home_address')
                                            ...
                                            <div class="input-box col-md-4">
                                                ...
                                                <input type="text" name="street" id="street"value="{{$personalinfos->street}}" class="form-control street light-gray-placeholder @error('street') is-invalid @enderror" placeholder="Street" autocomplete="new-password" value="{{ old('street') }}">
                                                @error('street')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            </div>
                                            ...
                                            <option value="{{$personalinfos->zip_code}}">{{$personalinfos->zip_code}}</option>
                                            ...
                                            <input type="number" name="contact_no" id="contact_no"value="{{$personalinfos->contact_no}}" class="form-control contact_no light-gray-placeholder @error('contact_no') is-invalid @enderror"placeholder="Contact no." autocomplete="new-password" value="{{ old('contact_no') }}" >
                                            @error('contact_no')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                            </div>
                                         ...
                                         <div class="input-box col-md-4">
                                            <span class="details">Religion</span>
                                                ...
                                                <option class="form-control light-gray-placeholder"value="{{$personalinfos->religion}}">Select Religion</option>
                                    ...
                                    <div class="input-box col-md-4" id="MariedInputSelected" style="display: none;">
                                        ...
                                        <input type="text" id="MariedInputSelected" value="{{$personalinfos->name_legal_spouse}}" name="name_legal_spouse" class="form-control name_legal_spouse light-gray-placeholder @error('mothers_maiden_name') is-invalid @enderror" placeholder="Name of spouse" autocomplete="new-password" value="{{ old('mothers_maiden_name') }}" onkeypress="return blockSymbolsAndNumbers(event)">
                                    ...
                                    <span class="details">Person with Disability</span>
                                        ...
                                        <option value="1" {{ $personalinfos->person_with_disability == 1 ? 'selected' : '' }}>Yes</option>
                                        <option value="0" {{ $personalinfos->person_with_disability == 0 ? 'selected' : '' }}>No</option>
                                    </select>
                                    </div>

                                    <div class="input-box col-md-4"id="YesInputSelected" style="display: none;" >
                                    <span class="details">PWD ID No.</span>
                                    <input type="number" name="pwd_id_no" id="YesInputSelected"value="{{$personalinfos->pwd_id_no}}" class="form-control YEspwd_id_no light-gray-placeholder @error('pwd_id_no') is-invalid @enderror" placeholder="Mother's Maiden Name" autocomplete="new-password" value="{{ old('pwd_id_no') }}" >
                                    @error('pwd_id_no')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                    </div>
                                    ...
                                    <option value="{{$personalinfos->government_issued_id}}">{{$personalinfos->government_isued_id}}</option>
                                    ...
                                    <input type="number"value="{{$personalinfos->gov_id_no}}" name="add_Idtype" id="add_Idtype" class="form-control add_Idtype light-gray-placeholder @error('add_Idtype') is-invalid @enderror" placeholder="gov. id no" autocomplete="new-password" value="{{ old('add_Idtype') }}" >
                                    @error('add_Idtype')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                    </div>
                                    ...
                                    <input type="text" name="id_types" value="{{$personalinfos->non_gov_id_types}}" id="non_gov_id_types" class="form-control non_gov_id_types light-gray-placeholder @error('id_types') is-invalid @enderror" placeholder="non-gov id" autocomplete="new-password" value="{{ old('id_types') }}" >
                                    @error('id_types')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                    </div>
                                ...
                                <div class="input-box col-md-4">
                                    ...
                                    <input type="text" class="form-control light-gray-placeholder name_contact_person @error('name_contact_person') is-invalid @enderror" value="{{$personalinfos->name_contact_person}}" name="name_contact_person" placeholder="Enter name of contact person" value="{{ old('name_contact_person') }}" id="contactPersonInput" onkeypress="return blockSymbolsAndNumbers(event)">
                                ...
                                <div class="input-box col-md-4">
                                    ...
                                    <input type="number" class="form-control cp_tel_no light-gray-placeholder @error('cp_tel_no') is-invalid @enderror" value="{{$personalinfos->cp_tel_no}}" name="cp_tel_no" placeholder="Enter your cp tel no"value="{{ old('cp_tel_no') }}" >
                                    @error('cp_tel_no')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                                </div>
                                <div class="input-box col-md-4">
                                    ...
                                    <input type="text" class="form-control light-gray-placeholder date_of_interviewed @error('date_of_interview') is-invalid @enderror" value="{{$personalinfos->date_interview}}" name="date_interview" id="datepicker" placeholder="Date of Interview" value="{{ old('date_of_interview') }}" data-input='true' required>
...
const csrfToken = $('input[name="_token"]').attr('value');
    ...
    $.ajax({
        url: '/agent-edit-farmers/{personalinfos}',
        method: 'POST',
...
$(document).ready(function() {
    ...
    function fetchAgriDistricts() {
        $.ajax({
            url: '/agent-edit-farmers/{personalinfos}', // Route for fetching AgriDistricts
            method: 'GET',
