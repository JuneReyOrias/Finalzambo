...
<div class="page-content">
    <div class="d-flex justify-content-between align-items-center grid-margin flex-wrap">
        <!-- Title -->
        <div>
            <h4 class="mb-3 mb-md-0" style="font-size: 19px;">Farmers Crops Report</h4>
        </div>
    </div>
    ...
    <div class="d-flex justify-content-between align-items-center grid-margin">
        ...
        <div class="d-flex align-items-center flex-wrap w-100">
            <form id="filterForm" method="GET" action="/agent-all-crops-report"  class="d-flex align-items-center flex-wrap w-100">
                <!-- Crop Dropdown -->
...
<script>
    $(document).ready(function () {
        ...
        $('#filterForm').on('submit', function (e) {
            ...
            $.ajax({
                url: '/agent-all-crops-report', // Adjust the route if needed
                method: 'GET',
                data: {
                    crop_name: cropName,
                    district: district,
...
$(document).ready(function () {
    ...
    function fetchFarmersData(page) {
        ...
        $.ajax({
            url: '/agent-all-crops-report?page=' + page,  // Adjust route to use a query string for the page number
            type: 'GET',
            data: { 
