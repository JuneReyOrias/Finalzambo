                    ...
                    <div class="tabs">
                        ...
                        <div class="tab">
                            <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                                ...
                                <div class="me-md-1">
                                    <a href="{{ route('landing-page.add_homepage') }}" class="btn btn-success">Add</a>
                                    ...
                                    <tbody>
                                        ...
                                        @foreach($Page as $landpage)
                                            <tr class="table-light">
                                                 ...
                                                 <td>{{$landpage->home_description }}</td>
                                                 <td>{{$landpage->home_logo }}</td>
                                                 <td>{{$landpage->home_imageslider }}</td>
                                                <td>{{$landpage->agri_logo}}</td>
                                                <td>{{$landpage->feature_header }}</td>
                                                <td>{{$landpage->feature_description	}}</td>
                                                <td>{{$landpage->agri_features }}</td>
                                                <td>{{$landpage->agri_description }}</td>
                        
                                                
                          
                                                <td>
                                                   
                                                     <a href="{{route('landing-page.edit_homepage',  $landpage->id)}}" title="Edit"><button class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</button></a> 
