...
<div class="page-content">
    ...
    <div class="card-forms border rounded">
        ...
        <div class="card-forms border rounded">
            ...
            <div class="content">
            <form id="multi-step-form" action{{url('updateFeatures')}} method="post" enctype="multipart/form-data">
                @csrf
                <div >
                ...
                <div id="step-1" class="form_1">
                    ...
                    <div class="user-details" id="featuresContainer">
                        ...
                        <div class="input-box">
                            ...
                            @if ($feature['icon'])
                                <img src="{{ asset($feature['icon']) }}" alt="Feature Icon" width="50">
                            @endif
                        </div>
                                <div class="input-box">
