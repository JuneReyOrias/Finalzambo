...
function checkSeedSource(cropCounter) {
    var selectSeedSource = document.getElementById(`seed_source`);
    var removeSeedSourceButton = document.getElementById(`removeSeedSourceButton`);
...
function removeSeedSource(cropCounter) {
    ...
    if (selectedValue && selectedValue !== "Add" && ![
        ...
        if (confirmRemove) {
            ...
            // Hide the remove button after removal
            document.getElementById(`removeSeedSourceButton`).style.display = "none";
        }
    } else {
        alert("You cannot remove a default option.");
    }
...
function checkParticular(cropCounter) {
    var selectParticular = document.getElementById(`particular`);
    var removeParticularButton = document.getElementById(`removeParticularButton`);
...
function removeParticular(cropCounter) {
    ...
    if (selectedValue && selectedValue !== "Other" && ![
        ...
        if (confirmRemove) {
            ...
            // Hide the remove button after removal
            document.getElementById(`removeParticularButton`).style.display = "none";
        }
    } else {
        alert("You cannot remove a default option.");
    }
...
function checkPlowing(cropCounter) {
    var selectPlowing = document.getElementById(`selectPlowing`);
    var removePlowingButton = document.getElementById(`removePlowingButton`);
...
function removePlowing(cropCounter) {
    ...
    if (selectedValue && selectedValue !== "OthersPlowing" && ![
        ...
        if (confirmRemove) {
            ...
            // Hide the remove button after removal
            document.getElementById(`removePlowingButton`).style.display = "none";
        }
    } else {
        alert("You cannot remove a default option.");
    }
...
function checkPlowingStatus(cropCounter) {
    var selectPlowingStatus = document.getElementById(`selectPlowingStatus`);
    var removePlowingStatusButton = document.getElementById(`removePlowingStatusButton`);
...
function removePlowingStatus(cropCounter) {
    ...
    if (selectedValue && selectedValue !== "Other" && !["Own", "Rent"].includes(selectedValue)) {
        ...
        if (confirmRemove) {
            ...
            // Hide the remove button after removal
            document.getElementById(`removePlowingStatusButton`).style.display = "none";
        }
    } else {
        alert("You cannot remove a default option.");
    }
...
function checkHarrowing(cropCounter) {
    var selectHarrowing = document.getElementById(`selectHarrowing`);
    var removeHarrowingButton = document.getElementById(`removeHarrowingButton`);
...
function removeHarrowing(cropCounter) {
    ...
    if (selectedValue && selectedValue !== "OthersHarrowing" && !["Hand Tractor", "Four-Wheel Tractors", "Compact Tractors", "Rice Transplanters", "Crawler Tractors"].includes(selectedValue)) {
        ...
        if (confirmRemove) {
            ...
            // Hide the remove button after removal
            document.getElementById(`removeHarrowingButton`).style.display = "none";
        }
    } else {
        alert("You cannot remove a default option.");
    }
...
function checkOwnershipStatus(cropCounter) {
    var selectOwnershipStatus = document.getElementById(`selectOwnershipStatus`);
    var removeOwnershipStatusButton = document.getElementById(`removeOwnershipStatusButton`);
...
function removeOwnershipStatus(cropCounter) {
    ...
    if (selectedValue && selectedValue !== "Other" && !["Own", "Rent"].includes(selectedValue)) {
        ...
        if (confirmRemove) {
            ...
            // Hide the remove button after removal
            document.getElementById(`removeOwnershipStatusButton`).style.display = "none";
        }
    } else {
        alert("You cannot remove a default option.");
    }
...
function checkHarvestingMachine(cropCounter) {
    var selectHarvestingMachine = document.getElementById(`selectHarvestingMachine`);
    var removeHarvestingMachineButton = document.getElementById(`removeHarvestingMachineButton`);
...
function removeHarvestingMachine(cropCounter) {
    ...
    if (selectedValue && selectedValue !== "Others" && !["Hand Tractor", "Four-Wheel Tractors", "Compact Tractors", "Rice Transplanters", "Crawler Tractors"].includes(selectedValue)) {
        ...
        if (confirmRemove) {
            ...
            // Hide the remove button after removal
            document.getElementById(`removeHarvestingMachineButton`).style.display = "none";
        }
    } else {
        alert("You cannot remove a default option.");
    }
...
function checkHarvestOwnership(cropCounter) {
    var selectHarvestOwnership = document.getElementById(`selectHarvestOwnership`);
    var removeHarvestOwnershipButton = document.getElementById(`removeHarvestOwnershipButton`);
...
function removeHarvestOwnership(cropCounter) {
    ...
    if (selectedValue && selectedValue !== "Other" && !["Own", "Rent"].includes(selectedValue)) {
        ...
        if (confirmRemove) {
            ...
            // Hide the remove button after removal
            document.getElementById(`removeHarvestOwnershipButton`).style.display = "none";
        }
    } else {
        alert("You cannot remove a default option.");
    }
...
function checkPostHarvestMachine(cropCounter) {
    var selectPostHarvestMachine = document.getElementById(`selectPostHarvestMachine`);
    var removePostHarvestMachineButton = document.getElementById(`removePostHarvestMachineButton`);
...
function removePostHarvestMachine(cropCounter) {
    ...
    if (selectedValue && selectedValue !== "OthersPostHarvest" && !["Hand Tractor", "Four-Wheel Tractors", "Compact Tractors", "Rice Transplanters", "Crawler Tractors"].includes(selectedValue)) {
        ...
        if (confirmRemove) {
            ...
            // Hide the remove button after removal
            document.getElementById(`removePostHarvestMachineButton`).style.display = "none";
        }
    } else {
        alert("You cannot remove a default option.");
    }
...
function checkPostHarvestOwnership(cropCounter) {
    var selectPostHarvestOwnership = document.getElementById(`selectPostHarvestOwnership`);
    var removePostHarvestOwnershipButton = document.getElementById(`removePostHarvestOwnershipButton`);
...
function removePostHarvestOwnership(cropCounter) {
    ...
    if (selectedValue && selectedValue !== "Other" && !["Own", "Rent"].includes(selectedValue)) {
        ...
        if (confirmRemove) {
            ...
            document.getElementById(`removePostHarvestOwnershipButton`).style.display = "none";
        }
    } else {
        alert("You cannot remove a default option.");
    }
...
$(document).on('click', '[id^=save_new_seed_]', function() {
    ...
    const newSeedName = $(`#new_seed_name`).val().trim();
    if (newSeedName === '') {
    ...
    const $seedSelect = $(`#selectSeedName`);
...
function handleSeedSelection(cropCounter) {
    const selectedValue = $(`#selectSeedName`).val();
    if (selectedValue === 'Add New') {
        $(`#addSeedModal`).modal('show');
    } else {
        // Show remove button if a valid seed is selected
        if (selectedValue !== '') {
            $(`#removeSeedButton`).show();
        } else {
            $(`#removeSeedButton`).hide();
        }
    }
}
...
function checkNameOfFertilizer(cropCounter) {
    var selectNameOfFertilizer = document.getElementById(`selectNameOfFertilizer`);
    var removeNameOfFertilizerButton = document.getElementById(`removeNameOfFertilizerButton`);
...
function removeNameOfFertilizer(cropCounter) {
    ...
    if (selectedValue && selectedValue !== "other" && ![
        ...
        if (confirmRemove) {
            ...
            document.getElementById(`removeNameOfFertilizerButton`).style.display = "none";
        }
    } else {
        alert("You cannot remove a default option.");
    }
...
function checkPesticideName(cropCounter) {
    ...
    var removePesticideNameButton = document.getElementById(`removePesticideNameButton`);
...
function removePesticideName(cropCounter) {
    ...
    if (selectedValue && selectedValue !== "OtherPestName" && ![
        ...
        if (confirmRemove) {
            ...
            document.getElementById(`removePesticideNameButton`).style.display = "none";
        }
    } else {
        alert("You cannot remove a default option.");
    }
...
function checkSeedName(cropCounter) {
    var seedSelect = document.getElementById(`seed_name`);
    var removeSeedButton = document.getElementById(`seed_remove`);
...
function removeSeed(cropCounter) {
    ...
    if (selectedValue && selectedValue !== "add" && ![
        ...
        if (confirmRemove) {
            ...
            document.getElementById(`seed_remove`).style.display = "none";
        }
    } else {
        alert("You cannot remove a default option.");
    }
...
function populateCropVariety(cropCounter, varieties) {
    var cropVarietySelect = document.getElementById(`crop_variety`);
...
function checkCropVariety(cropCounter) {
    var cropVarietySelect = document.getElementById(`crop_variety`);
    var removeVarietyButton = document.getElementById(`crop_variety_remove`);
...
function removeCropVariety(cropCounter) {
    ...
    if (selectedValue && ![
        ...
        if (confirmRemove) {
            ...
            document.getElementById(`crop_variety_remove`).style.display = "none";
        }
    } else {
        alert("You cannot remove a default option.");
    }
...
function Unit() {
    ...
    var selectedValue = selectUnit.value;

    if (selectedValue === "Add") {
        // Prompt the user to enter a new unit
        var newUnit = prompt("Please enter the new unit:");

        if (newUnit) {
            // Create a new option element with the user's input
            var newOption = document.createElement("option");
            newOption.text = newUnit;
            newOption.value = newUnit;

            // Add the new option to the select dropdown
            selectUnit.add(newOption);

            // Select the newly added option
            selectUnit.value = newUnit;

            // Show the remove button for the new option
            document.getElementById("removeUnitButton").style.display = "inline-block";
        } else {
            // If no input is provided, reset to the previous selection
            selectUnit.value = "tons"; // Default to a valid option
        }
    } else if (selectedValue !== "Add") {
        // Hide the remove button if a default option is selected
        document.getElementById("removeUnitButton").style.display = "none";
    }
}
...
function removeUnit() {
    ...
    var defaultOptions = ["tons", "kg", ];

    if (selectedValue && !defaultOptions.includes(selectedValue)) {
        var confirmRemove = confirm("Are you sure you want to remove this option?");
        if (confirmRemove) {
            // Remove the selected custom unit option
            var selectedIndex = selectUnit.selectedIndex;
            selectUnit.remove(selectedIndex);

            // Reset the selection to a default value
            selectUnit.value = "tons";
    ...
    document.getElementById('unit_price_rice_per_kg').addEventListener('input', calculateGrossIncome);
    document.getElementById('quantity').addEventListener('input', calculateGrossIncome);

    function calculateGrossIncome() {
        // Get the values from the inputs
        var unitPrice = parseFloat(document.getElementById('unit_price_rice_per_kg').value) || 0;
        var quantity = parseFloat(document.getElementById('quantity').value) || 0;

        // Calculate the gross income
        var grossIncome = unitPrice * quantity;

        // Set the result in the gross_income input
